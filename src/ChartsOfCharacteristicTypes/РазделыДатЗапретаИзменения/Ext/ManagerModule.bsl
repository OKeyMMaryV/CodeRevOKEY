...
Функция СвойстваРазделовДатЗапрета() Экспорт
	...
	Для Каждого Раздел Из Разделы Цикл
		...
		СвойстваРаздела = СвойстваРаздела( Раздел.Имя, РазделСсылка, Раздел.Представление, Новый ФиксированныйМассив(ТипыОбъектов));
	...
	СвойстваРаздела = СвойстваРаздела();
	СвойстваРаздела = Новый ФиксированнаяСтруктура(СвойстваРаздела);
	РазделыДатЗапрета.Вставить(СвойстваРаздела.Имя,    СвойстваРаздела);
	РазделыДатЗапрета.Вставить(СвойстваРаздела.Ссылка, СвойстваРаздела);
...
//     * Имя - Строка -
//
Функция СвойстваРаздела(Знач Имя = "", Знач Ссылка = Неопределено, Знач Представление = "", Знач ТипыОбъектов = Неопределено) Экспорт
	
	СвойстваРаздела = Новый Структура;
	СвойстваРаздела.Вставить("Имя", Имя);
	СвойстваРаздела.Вставить("Ссылка", ?(Ссылка = Неопределено, ПустаяСсылка(), Ссылка));
