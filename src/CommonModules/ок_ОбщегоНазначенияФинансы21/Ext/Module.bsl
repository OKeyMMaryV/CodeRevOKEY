...
// Функция получает имя настройки "ИмяДопСведенияНеЗагружатьПовторно"
// 
// Возвращаемое значение:
//  Строка - Имя настройки
//
Функция ПолучитьИмяНастройкиНеЗагружатьПовторно() Экспорт
	Возврат "ИмяДопСведенияНеЗагружатьПовторно";	
КонецФункции

// Функция получает идентификатор настройки "ИмяДопСведенияНеЗагружатьПовторно"
// 
// Возвращаемое значение:
//  Строка - Имя настройки
//
Функция ПолучитьИдентификаторНастройкиНеЗагружатьПовторно() Экспорт
	Возврат "ИдентификаторНастройкиНеЗагружатьПовторно";	
КонецФункции
