...
Процедура ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка) Экспорт
	...
	Если Форма.ИмяФормы = "Отчет.КассоваяКнига.Форма.ФормаОтчета" Тогда
		...
		#Область ТП_БП11_ФР19
		//ОКЕЙ Балыков А.Г. (ПервыйБИТ) Начало 2021-09-22 (#ТП_БП11_ФР19)
		//КомандаОтправитьПоПочте = Форма.Команды.Добавить("ок_ОтправитьПоПочте");
		//КомандаОтправитьПоПочте.Действие = "Подключаемый_ОтправитьПоПочте";
		//КомандаОтправитьПоПочте.Заголовок = НСтр("ru = 'Отправить по почте'");
		//
		//КомандаОтправитьПоПочте = Форма.Элементы.Добавить("ок_ОтправитьПоПочте", Тип("КнопкаФормы"), Форма.Элементы.КоманднаяПанельОтчета);
		//КомандаОтправитьПоПочте.Вид			= ВидКнопкиФормы.ОбычнаяКнопка;
		//КомандаОтправитьПоПочте.Отображение = ОтображениеКнопки.Картинка;
		//КомандаОтправитьПоПочте.Картинка	= БиблиотекаКартинок.ОтправитьЭлектронноеПисьмо;
		//КомандаОтправитьПоПочте.ИмяКоманды 	= "ок_ОтправитьПоПочте";
		//
		//КомандаМассоваяРассылкаПоПочте = Форма.Команды.Добавить("ок_МассоваяРассылкаПоПочте");
		//КомандаМассоваяРассылкаПоПочте.Действие 	= "Подключаемый_МассоваяРассылкаПоПочте";
		//КомандаМассоваяРассылкаПоПочте.Заголовок 	= НСтр("ru = 'Массовая рассылка по почте'");
		//
		//КомандаМассоваяРассылкаПоПочте = Форма.Элементы.Добавить("ок_МассоваяРассылкаПоПочте", Тип("КнопкаФормы"), Форма.Элементы.КоманднаяПанельОтчета);
		//КомандаМассоваяРассылкаПоПочте.Вид			= ВидКнопкиФормы.ОбычнаяКнопка;
		//КомандаМассоваяРассылкаПоПочте.Отображение 	= ОтображениеКнопки.КартинкаИТекст;
		//КомандаМассоваяРассылкаПоПочте.Картинка		= БиблиотекаКартинок.Отправить;
		//КомандаМассоваяРассылкаПоПочте.ИмяКоманды 	= "ок_МассоваяРассылкаПоПочте";
		//ОКЕЙ Балыков А.Г. (ПервыйБИТ) Конец 2021-09-22 (#ТП_БП11_ФР19)
		#КонецОбласти
	...
	#Область БП09
	//ОКЕЙ Дмитриева В.В. (ПервыйБИТ) Начало 2021-07-30 (#ТП_БП09_ФР07)
	Если Форма.ИмяФормы = "Справочник.Контрагенты.Форма.ФормаЭлемента" Тогда
		ГруппаОКЕЙ = Форма.Элементы.ГруппаОКЕЙ;
		
		ПолеАвтоПроведение = Форма.Элементы.Вставить("ок_ИсключатьИзАвтоматическогоПроведенияПремий", Тип("ПолеФормы"), ГруппаОКЕЙ);	      
		ПолеАвтоПроведение.Заголовок = НСтр("ru = 'Исключать из автоматического проведения премий'");
		ПолеАвтоПроведение.Вид = ВидПоляФормы.ПолеФлажка;
		ПолеАвтоПроведение.ПутьКДанным = "Объект.ок_ИсключатьИзАвтоматическогоПроведенияПремий"; 
		ПолеАвтоПроведение.ПоложениеЗаголовка = ПоложениеЗаголовкаЭлементаФормы.Право;
	КонецЕсли;
	//ОКЕЙ Дмитриева В.В. (ПервыйБИТ) Конец 2021-07-30 (#ТП_БП09_ФР07)	
	#КонецОбласти
	
	#Область БП10
	//ОКЕЙ Дмитриева В.В. (ПервыйБИТ) Начало 2021-10-26 (#ТП_БП10_ФР13)
	Если Форма.ИмяФормы = "Справочник.Контрагенты.Форма.ФормаЭлемента" Тогда
		ГруппаРезервирование = Форма.Элементы.Вставить("ГруппаРезервирование", Тип("ГруппаФормы"), Форма, Форма.Элементы.ГруппаДополнительныеРеквизиты);
		ГруппаРезервирование.Вид                   = ВидГруппыФормы.ОбычнаяГруппа;  		
		ГруппаРезервирование.ОтображатьЗаголовок   = Истина;
		ГруппаРезервирование.Заголовок             = НСтр("ru = 'Данные резервирования'");
		ГруппаРезервирование.Группировка           = ГруппировкаПодчиненныхЭлементовФормы.ГоризонтальнаяВсегда;
		ГруппаРезервирование.ОтображениеУправления = ОтображениеУправленияОбычнойГруппы.Картинка;
		ГруппаРезервирование.Поведение             = ПоведениеОбычнойГруппы.Свертываемая;
		ГруппаРезервирование.Отображение           = ОтображениеОбычнойГруппы.Нет;
		
		ПолеРезервированиеПоставок = Форма.Элементы.Вставить("ок_РезервированиеПоставок", Тип("ПолеФормы"), Форма.Элементы.ГруппаРезервирование);
		ПолеРезервированиеПоставок.Заголовок   = НСтр("ru = 'Резервирование поставок'");
		ПолеРезервированиеПоставок.Вид         = ВидПоляФормы.ПолеФлажка;
		ПолеРезервированиеПоставок.ПутьКДанным = "Объект.ок_РезервированиеПоставок";

		КомандаДанныеРезервирования = Форма.Команды.Добавить("ок_ДанныеРезервирования");
		КомандаДанныеРезервирования.Действие  = "Подключаемый_ДанныеРезервирования";
		КомандаДанныеРезервирования.Заголовок = НСтр("ru = 'Данные резервирования'");
		
		КомандаДанныеРезервирования = Форма.Элементы.Добавить("ок_ДанныеРезервирования", Тип("КнопкаФормы"), Форма.Элементы.ГруппаРезервирование);
		КомандаДанныеРезервирования.Вид	       = ВидКнопкиФормы.ОбычнаяКнопка;
		КомандаДанныеРезервирования.ИмяКоманды = "ок_ДанныеРезервирования";
	КонецЕсли; 
	
	Если Форма.ИмяФормы = "Документ.КорректировкаДолга.Форма.ФормаДокумента" Тогда
		Если Форма.Объект.ок_ВидКорректировки = Перечисления.ок_ВидыКорректировкиДолга.ВзаимозачетПоТоварнымПоставщикам Тогда
			ПериодРезервирования = Форма.Элементы.Вставить("ок_ПериодРезервирования", Тип("ПолеФормы"), Форма.Элементы.ГруппаШапкаЛевая);
			ПериодРезервирования.Заголовок   = НСтр("ru = 'Период резервирования'");
			ПериодРезервирования.Вид         = ВидПоляФормы.ПолеФлажка;
			ПериодРезервирования.ПутьКДанным = "Объект.ок_ПериодРезервирования";
		КонецЕсли;
	КонецЕсли; 
	//ОКЕЙ Дмитриева В.В. (ПервыйБИТ) Конец 2021-10-26 (#ТП_БП10_ФР13)
	
	//ОКЕЙ Дмитриева В.В. (ПервыйБИТ) Начало 2021-09-17 (#ТП_БП10_ФР21)
	Если Форма.ИмяФормы = "Документ.бит_ок_ОперацияАксапты12.Форма.ФормаДокумента" Тогда
		ПолеКонтрагент = Форма.Элементы.Вставить("Контрагент", Тип("ПолеФормы"), Форма.Элементы.Группа_Формы_2, Форма.Элементы.Группа_Формы_8);	      
		ПолеКонтрагент.Заголовок   = НСтр("ru = 'Контрагент'");
		ПолеКонтрагент.Вид         = ВидПоляФормы.ПолеВвода;
		ПолеКонтрагент.ПутьКДанным = "Объект.Контрагент";
		
		ПолеДоговор = Форма.Элементы.Вставить("ДоговорКонтрагента", Тип("ПолеФормы"), Форма.Элементы.Группа_Формы_2, Форма.Элементы.Группа_Формы_8);	      
		ПолеДоговор.Заголовок   = НСтр("ru = 'Договор'");
		ПолеДоговор.Вид         = ВидПоляФормы.ПолеВвода;
		ПолеДоговор.ПутьКДанным = "Объект.ДоговорКонтрагента";

		Если Форма.Объект.ТипДокумента = Справочники.бит_ок_ТипыОперацийАксапты.НайтиПоКоду("210") Тогда
					
			ГруппаСтраницыТГ           = Форма.Элементы.Добавить("СтраницаТГ", Тип("ГруппаФормы"), Форма.Элементы.ПанельДанных);
			ГруппаСтраницыТГ.Вид       = ВидГруппыФормы.Страница;
			ГруппаСтраницыТГ.Заголовок = НСтр("ru = 'Данные по товарным группам'"); 		
			
			ТаблицаТГ = Форма.Элементы.Добавить("ТаблицаТГ", Тип("ТаблицаФормы"),ГруппаСтраницыТГ);
			ТаблицаТГ.ПутьКДанным = "Объект.ок_ДанныеПоТГ";
			
			РеквизитКонтрагент = Форма.Элементы.Добавить("ТГКонтрагент", Тип("ПолеФормы"), ТаблицаТГ);
			РеквизитКонтрагент.Заголовок   = НСтр("ru = 'Контрагент'");
			РеквизитКонтрагент.Вид         = ВидПоляФормы.ПолеВвода;
			РеквизитКонтрагент.ПутьКДанным = "Объект.ок_ДанныеПоТГ.Контрагент";
			
			РеквизитДоговор = Форма.Элементы.Добавить("ТГДоговор", Тип("ПолеФормы"), ТаблицаТГ);
			РеквизитДоговор.Заголовок   = НСтр("ru = 'Договор'");
			РеквизитДоговор.Вид         = ВидПоляФормы.ПолеВвода;
			РеквизитДоговор.ПутьКДанным = "Объект.ок_ДанныеПоТГ.ДоговорКонтрагента";
						
			РеквизитТоварнаяГруппа = Форма.Элементы.Добавить("ТоварнаяГруппа", Тип("ПолеФормы"), ТаблицаТГ);
			РеквизитТоварнаяГруппа.Заголовок   = НСтр("ru = 'Товарная группа'");
			РеквизитТоварнаяГруппа.Вид         = ВидПоляФормы.ПолеВвода;
			РеквизитТоварнаяГруппа.ПутьКДанным = "Объект.ок_ДанныеПоТГ.ТоварнаяГруппа";
			
			РеквизитСрокИсполнения = Форма.Элементы.Добавить("СрокИсполнения", Тип("ПолеФормы"), ТаблицаТГ);
			РеквизитСрокИсполнения.Заголовок   = НСтр("ru = 'Срок исполнения'");
			РеквизитСрокИсполнения.Вид         = ВидПоляФормы.ПолеВвода;
			РеквизитСрокИсполнения.ПутьКДанным = "Объект.ок_ДанныеПоТГ.СрокИсполнения";
			
			РеквизитСтавкаНДС = Форма.Элементы.Добавить("СтавкаНДС", Тип("ПолеФормы"), ТаблицаТГ);
			РеквизитСтавкаНДС.Заголовок   = НСтр("ru = 'Ставка НДС'");
			РеквизитСтавкаНДС.Вид         = ВидПоляФормы.ПолеВвода;
			РеквизитСтавкаНДС.ПутьКДанным = "Объект.ок_ДанныеПоТГ.СтавкаНДС";
			
			РеквизитСуммаНДС = Форма.Элементы.Добавить("СуммаНДС", Тип("ПолеФормы"), ТаблицаТГ);
			РеквизитСуммаНДС.Заголовок   = НСтр("ru = 'Сумма НДС'");
			РеквизитСуммаНДС.Вид         = ВидПоляФормы.ПолеВвода;
			РеквизитСуммаНДС.ПутьКДанным = "Объект.ок_ДанныеПоТГ.СуммаНДС";
			
			РеквизитСуммаВзаиморасчетов = Форма.Элементы.Добавить("Сумма", Тип("ПолеФормы"), ТаблицаТГ);
			РеквизитСуммаВзаиморасчетов.Заголовок   = НСтр("ru = 'Сумма'");
			РеквизитСуммаВзаиморасчетов.Вид         = ВидПоляФормы.ПолеВвода;
			РеквизитСуммаВзаиморасчетов.ПутьКДанным = "Объект.ок_ДанныеПоТГ.Сумма";
		КонецЕсли;
	КонецЕсли;	
	//ОКЕЙ Дмитриева В.В. (ПервыйБИТ) Конец 2021-09-17 (#ТП_БП10_ФР21)
	
	//ОКЕЙ Балыков А.Г. (ПервыйБИТ) Начало 2021-09-21 (#ТП_БП10_ФР05)
	Если Форма.ИмяФормы = "Документ.АктСверкиВзаиморасчетов.Форма.ФормаДокумента" Тогда
		КомандаОтправитьАктСверки = Форма.Команды.Добавить("ок_ОтправитьАктСверки");
		КомандаОтправитьАктСверки.Действие = "Подключаемый_ОтправитьАктСверки";
		КомандаОтправитьАктСверки.Заголовок = НСтр("ru = 'Отправить акт сверки'");
		
		КомандаОтправитьАктСверки = Форма.Элементы.Добавить("ок_ОтправитьАктСверки", Тип("КнопкаФормы"), Форма.Элементы.ГруппаВажныеКоманды);
		КомандаОтправитьАктСверки.Вид			= ВидКнопкиФормы.ОбычнаяКнопка;
		КомандаОтправитьАктСверки.Отображение 	= ОтображениеКнопки.КартинкаИТекст;
		КомандаОтправитьАктСверки.Картинка	 	= БиблиотекаКартинок.Отправить;
		КомандаОтправитьАктСверки.ИмяКоманды 	= "ок_ОтправитьАктСверки";
	КонецЕсли;
	//ОКЕЙ Балыков А.Г. (ПервыйБИТ) Конец 2021-09-21 (#ТП_БП10_ФР05)
