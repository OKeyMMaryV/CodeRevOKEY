...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//ОКЕЙ Завьялова Е.А. (ПервыйБИТ) Начало 2021-05-07 (#ТП_БП05_ФР15)
	ок_МодификацияКонфигурацииПереопределяемый.ПриСозданииНаСервере(ЭтотОбъект, Отказ, СтандартнаяОбработка);
	//ОКЕЙ Завьялова Е.А. (ПервыйБИТ) Конец 2021-05-07 (#ТП_БП05_ФР15)
...
Процедура СписокПриАктивизацииСтроки(Элемент)
	...
	//ОКЕЙ Завьялова Е.А. (ПервыйБИТ) Начало 2021-05-07 (#ТП_БП05_ФР15)
	ок_УстановитьОтборОк_ДанныеФизическихЛицБОСС();
	//ОКЕЙ Завьялова Е.А. (ПервыйБИТ) Конец 2021-05-07 (#ТП_БП05_ФР15)
...
//ОКЕЙ Завьялова Е.А. (ПервыйБИТ) Начало 2021-05-07 (#ТП_БП05_ФР15)
&НаКлиенте
Процедура ок_УстановитьОтборОк_ДанныеФизическихЛицБОСС()
	
	Если Элементы.Список.ТекущиеДанные <> Неопределено Тогда
		ПравоеЗначение = Элементы.Список.ТекущиеДанные.Ссылка;
	Иначе
		ПравоеЗначение = ПредопределенноеЗначение("Справочник.ФизическиеЛица.ПустаяСсылка");
	КонецЕсли;
	
	ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(ЭтотОбъект.ок_ДанныеФизическихЛицБОСС,"ФизическоеЛицо", ПравоеЗначение, 
	...
	Если ЭтотОбъект.Параметры.РежимВыбора Тогда
		ОбщегоНазначенияКлиентСервер.УстановитьЭлементОтбораДинамическогоСписка(ЭтотОбъект.ок_ДанныеФизическихЛицБОСС,"Организация", ЭтотОбъект.ок_Организация,
			ВидСравненияКомпоновкиДанных.Равно, , Истина, РежимОтображенияЭлементаНастройкиКомпоновкиДанных.Недоступный);
	КонецЕсли;
...
&НаКлиенте
Процедура Подключаемый_ЗагрузитьИзБОСС(Команда)
	
	ПараметрыОткрытия = Новый Структура;
	ПараметрыОткрытия.Вставить("ок_Организация", ЭтотОбъект.ок_Организация);
	ОткрытьФорму("Обработка.ок_ЗагрузкаПодотчетныхЛицБОСС.Форма.Форма", ПараметрыОткрытия);
