...
Процедура ок_УстановитьОтборОк_ДанныеФизическихЛицБОСС()
	...
	ЭтаФОрма.ок_ДанныеФизическихЛицБОСС.Отбор.элементы.очистить();
	Отбор = ЭтаФОрма.ок_ДанныеФизическихЛицБОСС.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
	Отбор.ВидСравнения = ВидСравненияКомпоновкиДанных.Равно;
	Если элементы.список.ТекущиеДанные<> Неопределено Тогда
		Отбор.ПравоеЗначение = элементы.список.ТекущиеДанные.Ссылка;
	Иначе
		Отбор.ПравоеЗначение = ПредопределенноеЗначение("Справочник.ФизическиеЛица.ПустаяСсылка");
	КонецЕсли;
	...
	Если ЭтаФОрма.Параметры.РежимВыбора Тогда
		Отбор = ЭтаФОрма.ок_ДанныеФизическихЛицБОСС.Отбор.Элементы.Добавить(Тип("ЭлементОтбораКомпоновкиДанных"));
		Отбор.ВидСравнения = ВидСравненияКомпоновкиДанных.Равно;
		Отбор.ПравоеЗначение = ЭтаФОрма.ок_Организация;
...
КонецПроцедуры
&НаКлиенте
Процедура ок_ЗагрузитьИзБОСС(Команда)
	
	ПараметрыОткрытия = Новый Структура;
	ПараметрыОткрытия.Вставить("ок_Организация", ЭтаФорма.ок_Организация);
