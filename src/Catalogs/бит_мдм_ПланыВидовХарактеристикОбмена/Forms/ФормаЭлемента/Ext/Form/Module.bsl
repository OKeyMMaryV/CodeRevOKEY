...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Объект.ОписаниеОбъекта) Тогда
		...
		фСсылкаИсточник    = ПланыВидовХарактеристик[Объект.ОписаниеОбъекта.Имя].ПолучитьСсылку(Новый УникальныйИдентификатор(Объект.ИД));
		фИмяФормыИсточника = "ПланВидовХарактеристик."+Объект.ОписаниеОбъекта.Имя+".ФормаОбъекта";
