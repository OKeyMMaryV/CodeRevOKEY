...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//++ СВВ {[+](фрагмент добавлен), Администратор 17.07.2015 11:27:48
	ИжТиСи_СВД_Сервер.ОК_ВывестиРеквизиты(ЭтаФорма, "Справочник.ОсновныеСредства.ФормаГрупповогоСоздания");
	//-- СВВ}Администратор 17.07.2015 11:27:48
...
Функция СоздатьЭлементыСправочника()
	...
	Для НомерЭлемента = 1 По Количество Цикл
		...
		//++ СВВ {[+](фрагмент добавлен), Сапожников Вадим 17.07.2015 11:42:42
		УстновитьДолполнительныеРеквизиты(НовыйЭлемент);
		//-- СВВ}Сапожников Вадим 17.07.2015 11:42:42
...
&НаСервере
Процедура УстновитьДолполнительныеРеквизиты(НовыйЭлемент)
	
	НовыйЭлемент.Объект=Объект;
	НовыйЭлемент.БИТ_ГруппаОСУУ=БИТ_ГруппаОСУУ;
