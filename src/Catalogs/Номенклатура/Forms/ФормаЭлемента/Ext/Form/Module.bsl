...
Процедура ПередЗаписьюНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	ТекущийОбъект.ПодконтрольнаяПродукцияВЕТИС = ГосударственныйКонтроль = "ВЕТИС";
	ТекущийОбъект.ТабачнаяПродукция            = ГосударственныйКонтроль = "МОТП";
	ТекущийОбъект.ОбувнаяПродукция             = ГосударственныйКонтроль = "ИСМП";
