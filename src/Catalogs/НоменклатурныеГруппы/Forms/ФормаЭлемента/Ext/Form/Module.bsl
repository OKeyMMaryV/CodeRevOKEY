...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//++ СВВ {[+](фрагмент добавлен), Сапожников Вадим 17.07.2015 10:57:21
	ИжТиСи_СВД_Сервер.ОК_ВывестиРеквизиты(ЭтаФорма, "Справочник.НоменклатурныеГруппы.ФормаЭлемента");
	//-- СВВ}Сапожников Вадим 17.07.2015 10:57:21
