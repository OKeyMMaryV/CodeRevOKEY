...
Функция ПечатьАвансовогоОтчета(МассивОбъектов, ОбъектыПечати, СОстатком = Истина)
	...
	Пока Шапка.Следующий() Цикл
		...
		Если Шапка.Ссылка.ВыданныеАвансы.Итог("ок_СуммаАванса") = Шапка.Ссылка.СуммаДокумента 
			или ПолучитьДокументДляОстатка(МассивАО,  Шапка.Ссылка.ФизЛицо)Тогда
...
Функция ПолучитьДокументДляОстатка(МассивДокументовРасчета, ПодотчетноеЛицо)
	...
	Запрос.Текст = 
		...
		|			,
		|			ДокументРасчетов В (&ДокументыАванса)
