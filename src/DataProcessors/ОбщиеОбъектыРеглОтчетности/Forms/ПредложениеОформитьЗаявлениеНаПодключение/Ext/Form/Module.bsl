...
Функция МакетВидеоСКотом(
	...
	|
	|	" + ?(ЭтоМалопроизводительныйКомпьютер, "", "
	|	function getPlayer()
	|	{
	...
	|			</div>
	|			" + ?(ЭтоМалопроизводительныйКомпьютер, "", "<div class='layer bg'>
	...
	|				" + ?(ЭтоМалопроизводительныйКомпьютер, "<div class='layer bg_stub'>
	|					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
						+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
						+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
						+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
	...
	ДанныеКартинкиСКотомЗаменыАнимацииBase64 = "";
	Если СтрЧислоСтрок(ДанныеКартинкиСКотомBase64) > 1 Тогда
		ДанныеКартинкиСКотомЗаменыАнимацииBase64 = СтрПолучитьСтроку(ДанныеКартинкиСКотомBase64, 2);
		ДанныеКартинкиСКотомBase64 = СтрПолучитьСтроку(ДанныеКартинкиСКотомBase64, 1);
	КонецЕсли;
	
	// Картинка с котом и сноской для ссылки
	Если ЭтоМалопроизводительныйКомпьютер Тогда
		ДанныеКартинкиСКотом2Base64 = ДанныеКартинкиСКотомЗаменыАнимацииBase64;
	Иначе
