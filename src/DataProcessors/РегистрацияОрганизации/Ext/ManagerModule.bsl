...
Процедура ЗаполнитьУведомлениеОПостановкеНаУчетИП(ПараметрыОтчета, Контейнер) Экспорт
	...
	ИначеЕсли ЗначениеЗаполнено(СведенияОбОрганизации.Гражд) Тогда
		// Иностранец
		ДанныеЛиста.Вставить("П01010201", СтроковыеФункции.СтрокаЛатиницей(СведенияОбОрганизации.ФамилияИП));
		ДанныеЛиста.Вставить("П01010202", СтроковыеФункции.СтрокаЛатиницей(СведенияОбОрганизации.ИмяИП));
		ДанныеЛиста.Вставить("П01010203", СтроковыеФункции.СтрокаЛатиницей(СведенияОбОрганизации.ОтчествоИП));
