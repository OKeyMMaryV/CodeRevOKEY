...
Процедура ЗаполнитьОписаниеРазделаОСНМА(ОписаниеФункциональности)
	...
	Функциональность = ДобавитьОписаниеФункциональности(ОписаниеФункциональности, Раздел, "ВедетсяУчетПредметовАренды");
...
Процедура ЗаполнитьОписаниеРазделаТорговля(ОписаниеФункциональности)
	...
	Функциональность = ДобавитьОписаниеФункциональности(ОписаниеФункциональности, Раздел, "ВестиУчетПрослеживаемыхТоваров");
	Функциональность.ДоступнаВПростомИнтерфейсе = Истина;
	Функциональность.ТребуетсяДляОбменов = Истина;
...
Функция ОтказСнятьВедетсяУчетЛизинговогоИмущества()
	...
	НоваяСтрока = ТаблицаЗапросов.Добавить();
	НоваяСтрока.ТекстЗапроса = ТекстЗапросаИспользуетсяДокумент("ПоступлениеВАренду");

	НоваяСтрока = ТаблицаЗапросов.Добавить();
	НоваяСтрока.ТекстЗапроса = ТекстЗапросаИспользуетсяДокумент("ИзменениеУсловийАренды", Истина);
	...
	ВидыОпераций.Добавить(Перечисления.ВидыОперацийПоступлениеВАренду.ПоступлениеВЛизинг);
	ВидыОпераций.Добавить(Перечисления.ВидыОперацийИзменениеУсловийАренды.ИзменениеУсловийЛизинга);
...
Функция ТаблицаЗапросовВедетсяУчетЛизинговогоИмущества()
	...
	НоваяСтрока = ТаблицаЗапросов.Добавить();
	НоваяСтрока.ИмяДокумента = "ПоступлениеВАренду";
	НоваяСтрока.ТекстЗапроса = ТекстЗапросаИспользуетсяДокумент("ПоступлениеВАренду", Истина, Ложь);
	
	НоваяСтрока = ТаблицаЗапросов.Добавить();
	НоваяСтрока.ИмяДокумента = "ИзменениеУсловийАренды";
	НоваяСтрока.ТекстЗапроса = ТекстЗапросаИспользуетсяДокумент("ИзменениеУсловийАренды", Истина, Ложь);
...
#Область ВедетсяУчетПредметовАренды
...
Функция ОтказСнятьВедетсяУчетПредметовАренды()
	...
	НоваяСтрока = ТаблицаЗапросов.Добавить();
	НоваяСтрока.ТекстЗапроса = ТекстЗапросаИспользуетсяДокумент("ПоступлениеВАренду", Истина);
	...
	ВидыОпераций = Новый Массив;
	ВидыОпераций.Добавить(Перечисления.ВидыОперацийПоступлениеВАренду.ПоступлениеВАренду);
	ВидыОпераций.Добавить(Перечисления.ВидыОперацийИзменениеУсловийАренды.ИзменениеУсловийАренды);
	Запрос.УстановитьПараметр("ВидыОпераций", ВидыОпераций);
...
Функция ДокументыПрепятствующиеОтключениюУчетаПредметовАренды()
	
	ТаблицаРезультатовЗапросов = ПустаяТаблицаДокументовПрепятствующиеОтключениюОпции();
	
	ТаблицаЗапросов = ТаблицаЗапросовВедетсяУчетПредметовАренды();
...
Функция ТаблицаЗапросовВедетсяУчетПредметовАренды()
...
Процедура СформироватьСписокДокументовПрепятствующихОтключениюОпции(Параметры, АдресХранилища) Экспорт
	...
	ИначеЕсли Параметры.Свойство("ВедетсяУчетЛизинговогоИмущества") Тогда 
		...
		ОбластьШапка.Параметры.Заголовок = НСтр("ru = 'Лизинг'");
	ИначеЕсли Параметры.Свойство("ВедетсяУчетПредметовАренды") Тогда 
		ТаблицаРезультатовЗапросов = ДокументыПрепятствующиеОтключениюУчетаПредметовАренды();
		ОбластьШапка.Параметры.Заголовок = НСтр("ru = 'Права пользования предметами аренды'");
