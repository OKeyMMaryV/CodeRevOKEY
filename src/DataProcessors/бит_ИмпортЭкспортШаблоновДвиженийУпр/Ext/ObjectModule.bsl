...
// Процедура выгружает шаблоны в файл XML.
// 
Процедура ВыгрузитьШаблоны(ФайлВыгрузки, СписокКомплектов, СписокШаблонов) Экспорт
	
	// Сформируем заголовок файла обмена
	ЗаписьXML = НачатьЗаписьФайлаЭкспорта(ФайлВыгрузки);
...
Процедура ЗаписатьВидыРеквизитовДвижений(ЗаписьXML, СписокШаблонов) Экспорт
	...
	// //Выберем все реквизиты движений
	// Выборка = Справочники.бит_ВидыРеквизитовДвижений.Выбрать();
