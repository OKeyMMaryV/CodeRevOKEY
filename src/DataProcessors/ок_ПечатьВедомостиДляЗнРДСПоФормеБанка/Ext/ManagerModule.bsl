...
Процедура Печать(МассивОбъектов, ПараметрыПечати, КоллекцияПечатныхФорм, ОбъектыПечати, ПараметрыВывода) Экспорт
	...
	Если МассивОбъектовРайффайзенБанк.Количество() Тогда
		...
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм,
				...
				НСтр("ru = 'Ведомость райффайзен банк'"),
	...
	Если МассивОбъектовБезПечатнойФормы.Количество() Тогда
		...
		УправлениеПечатью.ВывестиТабличныйДокументВКоллекцию(КоллекцияПечатныхФорм,
				...
				НСтр("ru = 'Печатная форма не установлена'"),
...
Функция ПечатьВедомостьРосбанк(МассивОбъектов, ОбъектыПечати) Экспорт
	...
	//ОКЕЙ Дмитриева В.В. (ПервыйБИТ) Начало 2021-11-12 (#AT-2155946)
	//|	бит_ЗаявкаНаРасходованиеСредств.Дата КАК ДатаДокумента,
	// Заменено на:
	|	бит_ЗаявкаНаРасходованиеСредств.ДатаРасхода КАК ДатаДокумента,
	//ОКЕЙ Дмитриева В.В. (ПервыйБИТ) Конец 2021-11-12 (#AT-2155946)
	...
	//ОКЕЙ Дмитриева В.В. (ПервыйБИТ) Начало 2021-11-19 (#AT-2157620#)
	|,	ЕСТЬNULL(ЗначениеНомерКонтракта.Значение, 0) КАК НомерКонтракта,
	|	ЕСТЬNULL(ЗначениеИДКлиента.Значение, 0) КАК IDКлиента
	//ОКЕЙ Дмитриева В.В. (ПервыйБИТ) Конец 2021-11-19 (#AT-2157620#)
	...
	//ОКЕЙ Дмитриева В.В. (ПервыйБИТ) Начало 2021-11-19 (#AT-2157620#)
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.Организации.ДополнительныеРеквизиты КАК ЗначениеНомерКонтракта
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ ПланВидовХарактеристик.ДополнительныеРеквизитыИСведения КАК СвойствоНомерКонтракта
	|			ПО (ЗначениеНомерКонтракта.Свойство = СвойствоНомерКонтракта.Ссылка)
	|				И (СвойствоНомерКонтракта.Имя = ""Contract_Rosbank"")
	|		ПО (бит_ЗаявкаНаРасходованиеСредств.Организация = ЗначениеНомерКонтракта.Ссылка)
	|		ЛЕВОЕ СОЕДИНЕНИЕ Справочник.Организации.ДополнительныеРеквизиты КАК ЗначениеИДКлиента
	|			ВНУТРЕННЕЕ СОЕДИНЕНИЕ ПланВидовХарактеристик.ДополнительныеРеквизитыИСведения КАК СвойствоИДКлиента
	|			ПО (ЗначениеИДКлиента.Свойство = СвойствоИДКлиента.Ссылка)
	|				И (СвойствоИДКлиента.Имя = ""Customer_ID_Rosbank"")
	|		ПО (бит_ЗаявкаНаРасходованиеСредств.Организация = ЗначениеИДКлиента.Ссылка)
	//ОКЕЙ Дмитриева В.В. (ПервыйБИТ) Конец 2021-11-19 (#AT-2157620#)
