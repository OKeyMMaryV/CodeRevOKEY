...
Процедура РучнаяТрансляцияЗагруженныхДанныхИзАксапты() Экспорт
	...
	//ОКЕЙ Поздняков А.С. (СофтЛаб) Начало 2021-07-13 (#4183)
	...
	//ОКЕЙ Поздняков А.С. (СофтЛаб) Конец 2021-07-13 (#4183)
	...
	Для Каждого ТекущаяОчередь из МассивОчередей Цикл 
		...
		Если Очередность = 5 Тогда //ДДС
			...
			|
			|////////////////////////////////////////////////////////////////////////////////
			//ОКЕЙ Поздняков А.С. (СофтЛаб) Начало 2021-07-21 (#4183)
			//|ВЫБРАТЬ
			|ВЫБРАТЬ РАЗЛИЧНЫЕ
			//ОКЕЙ Поздняков А.С. (СофтЛаб) Конец 2021-07-21 (#4183)
		...
		//ОКЕЙ Поздняков А.С. (СофтЛаб) Начало 2021-06-16 (#4183)
		//Если НЕ ТрансляцияТолькоНеоттранслированных Тогда
		//	Прервать;
		//КонецЕсли;
		//ОКЕЙ Поздняков А.С. (СофтЛаб) Конец 2021-06-16 (#4183)
...
Процедура ЗаполнитьНастройки() Экспорт 
	...
	ОпределитьНастройку(ТЗНастройки, "Начало Периода Фреш Маркет", ПериодС);
	ОпределитьНастройку(ТЗНастройки, "Конец Периода Фреш Маркет", ПериодПо);
