...
//бит_ASubbotina Процедура управляет флагами в табличной части
//
// Парметры:
...
Процедура ОбработатьФлаги(ЗначениеФлага)
	...
	Для каждого СтрокаТаблицы Из Объект.ПереченьОбъектов Цикл
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//	Возврат;
	//КонецЕсли;
	МетаданныеОбъекта = Метаданные.Обработки.бит_му_ПодборВНАПринятиеМодернизация;
	
	//Команда = Параметры.Команда;
	//
	//Если Команда = "" Тогда
	//	бит_ОбщегоНазначенияКлиентСервер.ВывестиСообщениеОЗапретеСамостаятельногоОткрытияОбработки(МетаданныеОбъекта, Отказ);
	//	Возврат;
	//КонецЕсли;
