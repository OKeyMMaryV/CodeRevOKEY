...
Процедура ЗагрузитьДанные(Параметры)
	...
	Для Каждого Элемент Из СправочникБИК.bics Цикл 
		...
		Если ЗначениеЗаполнено(ДанныеОрганизации.Счета) Тогда
			Для Каждого ОписаниеСчета Из ДанныеОрганизации.Счета Цикл
				...
				КонецЕсли;
				АктуальныеЗаписи.Добавить(ЗаписатьЭлементКлассификатораБанковРФ(ДанныеОрганизации, Параметры.СписокИзмененныхБанков)); // БП
			КонецЦикла;
		Иначе
	...
	ОтметитьНеактуальныеЗаписи(АктуальныеЗаписи, Параметры.СписокИзмененныхБанков); // БП
...
Процедура ОтметитьНеактуальныеЗаписи(АктуальныеЗаписи, СписокИзмененныхБанков) // БП
...
//
Функция ЗаписатьЭлементКлассификатораБанковРФ(СведенияОБанке, СписокИзмененныхБанков) // БП
