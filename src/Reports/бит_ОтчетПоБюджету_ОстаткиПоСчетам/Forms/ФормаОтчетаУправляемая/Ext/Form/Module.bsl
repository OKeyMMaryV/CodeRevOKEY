...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	МетаданныеОбъекта = Метаданные.Отчеты.бит_ОтчетПоБюджету_ОстаткиПоСчетам;
...
Процедура ОбработкаРасшифровкиОтчета(Расшифровка, СтандартнаяОбработка, ОткрыватьДопЗначение = Ложь)
	...
	ДополнительныеПунктыМеню.Добавить("бит_ДанныеБюджета_ОстаткиПоСчетам", "Данные бюджета");
	
	ДополнительныеПараметры = Новый Структура;	
	ДополнительныеПараметры.Вставить("Бюджет"		, Отчет.Бюджет);
    ДополнительныеПараметры.Вставить("Период"		, Отчет.Период);
    ДополнительныеПараметры.Вставить("Периодичность", Отчет.Периодичность);
