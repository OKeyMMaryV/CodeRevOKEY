...
Процедура СформироватьОтчет(Команда)
	...
	УИДЗамера = ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Ложь, "ФормированиеОтчетабит_ОборотноСальдоваяВедомостьПоСчету");
	// СтандартныеПодсистемы.ОценкаПроизводительности.
...
Функция ПолучитьЗапрещенныеПоля(Режим = "") Экспорт
	...
	Если Не бит_БухгалтерскийУчетВызовСервераПовтИсп.ПолучитьСвойстваСчета(Отчет.Счет).УчетПоПодразделениям Тогда
