...
Функция ТаблицаФормОтчета() Экспорт
	...
	Если ТекущаяДатаСеанса() >= ДатаПримененияФормыВНовойРедакции() Тогда
		...
		НоваяФорма.ОписаниеОтчета     = "Приложение № 1 к приказу ФНС России от 08.07.2021 № ЕД-7-15/645@.";
	...
	Иначе
		...
		НоваяФорма = ТаблицаФормОтчета.Добавить();
		НоваяФорма.ФормаОтчета        = "ФормаОтчета2021Кв3";
		НоваяФорма.ОписаниеОтчета     = "Приложение № 1 к письму ФНС России от 14.04.2021 № ЕА-4-15/5042@.";
...
Функция ДеревоФормИФорматов() Экспорт
	...
	Если ТекущаяДатаСеанса() >= ДатаПримененияФормыВНовойРедакции() Тогда
		...
		"1169009", '2021-07-08', "ЕД-7-15/645@", "ФормаОтчета2021Кв3");
		ОпределитьФорматВДеревеФормИФорматов(ФормаОтчета2021Кв3, "5.02");
		
	Иначе
		
		ФормаОтчета2021Кв3 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы,
		"1169009", '2021-04-14', "ЕА-4-15/5042@", "ФормаОтчета2021Кв3");
