...
Функция ПечатьСразу(Объект, ИмяФормы) Экспорт
	Если ИмяФормы = "Форма2020_1" Тогда
		Возврат ПечатьСразу_Форма2020_1(Объект);
	КонецЕсли;
...
Функция СформироватьМакет(Объект, ИмяФормы) Экспорт
	Если ИмяФормы = "Форма2020_1" Тогда
		Возврат СформироватьМакет_Форма2020_1(Объект);
	КонецЕсли;
	Возврат Неопределено;
КонецФункции
...
Функция ПечатьСразу_Форма2020_1(Объект)
	ПечатнаяФорма = СформироватьМакет_Форма2020_1(Объект);
...
Функция СформироватьМакет_Форма2020_1(Объект)
