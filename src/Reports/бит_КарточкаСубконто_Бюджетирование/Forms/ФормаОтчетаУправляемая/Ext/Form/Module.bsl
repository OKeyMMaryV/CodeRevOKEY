...
Процедура ТаблицаОтборПриОкончанииРедактирования(Элемент, НоваяСтрока, ОтменаРедактирования)
	...
	бит_БухгалтерскиеОтчетыКлиент.ОбновитьОтборОсновныхНастроекПоТаблицеОтборов(Отчет, Элементы.ТаблицаОтбор, "Сценарий");
	// Изменение кода. Начало. 07.05.2014{{
	бит_БухгалтерскиеОтчетыКлиент.ОбновитьОтборОсновныхНастроекПоТаблицеОтборов(Отчет, Элементы.ТаблицаОтбор, "Организация");
    // Изменение кода. Конец. 07.05.2014}}
