...
Функция ПодготовитьПараметрыОтчета()
	...
	// 1С-ИжТиСи Полина 10.03.2015 (
	ПараметрыОтчета.Вставить("ИсточникДанных"                     , Отчет.ИсточникДанных);
	// 1С-ИжТиСи Полина 10.03.2015 )
...
Процедура ОбновитьТекстЗаголовка(Форма)
	...
	ЗаголовокОтчета = "Отчет по проводкам (С корректировкой)" + БухгалтерскиеОтчетыКлиентСервер.ПолучитьПредставлениеПериода(Отчет.НачалоПериода, Отчет.КонецПериода);
...
Процедура РезультатОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
	...
	СБ_МеханизмКонтроляТрансляцииКлиент.ОбработкаРасшифровкиСтандартногоОтчета(ЭтаФорма, Элемент, Расшифровка, СтандартнаяОбработка);
...
Процедура ПриОткрытии(Отказ)
	...
	КлючеваяОперация = "ФормированиеОтчетаОтчетПоПроводкамСКорректировкой";
