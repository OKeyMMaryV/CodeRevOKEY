...
Функция СформироватьПустоеДеревоСтраниц(ВыбраннаяФорма)
	...
	Стр001.ИДНаименования = ?(ВыбраннаяФорма = "Форма2018_1", "Титульная_2018", "Титульная");
	...
	Стр001.ИндексКартинки = 1;
	Стр001.ИмяМакета = ?(ВыбраннаяФорма = "Форма2018_1", "Лист001_2018", "Лист001");
	Стр001.Многостраничность = Ложь;
	Стр001.Многострочность = Ложь;
	Стр001.УИД = Новый УникальныйИдентификатор;
	Стр001.ИДНаименования = ?(ВыбраннаяФорма = "Форма2018_1", "Лист001_2018", "Лист001");
	Стр001.МакетыПФ = ?(ВыбраннаяФорма = "Форма2018_1", "Печать_Форма2018_1_Лист001", "Печать_Форма2017_1_Лист001");
	...
	Стр001.Многострочность = Ложь;
	Стр001.УИД = Новый УникальныйИдентификатор;
	Стр001.ИДНаименования = ?(ВыбраннаяФорма = "Форма2018_1", "Лист002_2018", "Лист002");
