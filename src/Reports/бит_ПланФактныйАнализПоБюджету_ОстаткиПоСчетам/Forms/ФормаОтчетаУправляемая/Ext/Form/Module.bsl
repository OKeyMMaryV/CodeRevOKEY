...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.СтраницаКомпоновщик.Видимость = фЭтоРасшифровка;
...
Процедура ОбработкаРасшифровкиОтчета(Расшифровка, СтандартнаяОбработка, ОткрыватьДопЗначение = Ложь)
	...
	////ДополнительныеПараметры.Вставить("ДобавитьСценарийВОтборы", Истина);
	//ДополнительныеПараметры.Вставить("Сценарий"		 		  , Отчет.Сценарий);
	//ДополнительныеПараметры.Вставить("СценарийЭталон"		  , Отчет.СценарийЭталон);
...
// Функция проверяет, если период не указан.
// 
&НаКлиенте
Функция ПроверкаПериода()
	...
	Если Не ЗначениеЗаполнено(Отчет.Период.ДатаНачала) ИЛИ Не ЗначениеЗаполнено(Отчет.Период.ДатаОкончания) Тогда
		ТекстСообщения = НСтр( "ru = 'Укажите даты начала и окончания периода!'");
		бит_ОбщегоНазначенияКлиентСервер.ВывестиСообщение(ТекстСообщения);
