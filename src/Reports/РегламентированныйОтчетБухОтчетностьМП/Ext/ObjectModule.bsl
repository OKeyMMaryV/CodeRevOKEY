...
Процедура СформироватьСтруктуруПоказателей(ИмяФормы, ДанныеОтчета, СтруктураРеквизитовФормы) Экспорт
	...
	РасчетСтроки6300Гр3 = ОЦИС.П000100631003 + ОЦИС.П000100632003 + ОЦИС.П000100633003 + ОЦИС.П000100635003;
	РасчетСтроки6300Гр4 = ОЦИС.П000100631004 + ОЦИС.П000100632004 + ОЦИС.П000100633004 + ОЦИС.П000100635004;
	
	ОЦИС.Вставить("П100100630003", -РасчетСтроки6300Гр3); // вычитаемый
	ОЦИС.Вставить("П100100630004", -РасчетСтроки6300Гр4); // вычитаемый
