...
Функция ТаблицаФормОтчета() Экспорт
	...
	Если ТекущаяДатаСеанса() >= ДатаПримененияФормыВНовойРедакции() Тогда
		...
		НоваяФорма.ОписаниеОтчета     = "Приложение № 4 к приказу ФНС России от 08.07.2021 № ЕД-7-15/645@.";
		НоваяФорма.РедакцияФормы      = "от 08.07.2021 № ЕД-7-15/645@.";
		НоваяФорма.ДатаНачалоДействия = '2021-06-22';
	...
	Иначе
		...
		НоваяФорма = ТаблицаФормОтчета.Добавить();
		НоваяФорма.ФормаОтчета        = "ФормаОтчета2021Кв3";
		НоваяФорма.ОписаниеОтчета     = "Приложение № 4 к письму ФНС России от 14.04.2021 № ЕА-4-15/5042@.";
...
Функция ДеревоФормИФорматов() Экспорт
	...
	Если ТекущаяДатаСеанса() >= ДатаПримененияФормыВНовойРедакции() Тогда
		...
		"1169010", '2021-07-08', "ЕД-7-15/645@", "ФормаОтчета2021Кв3");
		ОпределитьФорматВДеревеФормИФорматов(Форма2021Кв3, "5.02");
		
	Иначе
		
		Форма2021Кв3 = ОпределитьФормуВДеревеФормИФорматов(ФормыИФорматы,
		"1169010", '2021-04-14', "ЕА-4-15/5042@", "ФормаОтчета2021Кв3");
