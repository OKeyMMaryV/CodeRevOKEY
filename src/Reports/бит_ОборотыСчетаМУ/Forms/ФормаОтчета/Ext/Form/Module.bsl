...
Процедура СформироватьОтчет(Команда)
	...
	УИДЗамера = ОценкаПроизводительностиКлиент.НачатьЗамерВремени(Ложь, "ФормированиеОтчетабит_ОборотыСчетаМУ");
	// СтандартныеПодсистемы.ОценкаПроизводительности
...
Процедура ИзменениеСхемыКомпоновкиДанныхНаСервере() Экспорт
	...
	Отчеты.бит_ОборотыСчетаМУ.НастроитьСхемуКомпоновкиДанных(Отчет, Схема); 
		...
		Если Отчет.РежимРасшифровки Тогда
			Для Каждого ЭлементОтбора Из Отчет.КомпоновщикНастроек.Настройки.Отбор.Элементы Цикл
				Если ТипЗнч(ЭлементОтбора) = Тип("ЭлементОтбораКомпоновкиДанных") Тогда 
					...
					ИначеЕсли ЛевоеЗначениеОтбора = "Субконто4" Тогда
						КоличествоВключенныхСубконто = 4;	
						Прервать;
					КонецЕсли;	
				КонецЕсли;
			КонецЦикла;
