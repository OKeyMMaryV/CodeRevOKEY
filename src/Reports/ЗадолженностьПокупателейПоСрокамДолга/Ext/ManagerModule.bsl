...
// бит_Финанс 26.02.2019. Добавлено ключевое слово "Экспорт".
// Процедура используется при формировании данныха для PowerBI, общий модуль бит_PowerBIПереопределяемый.
Процедура ЗаполнитьПоляВСоответствииСоСпискомИнтервалов(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
...
// бит_Финанс 26.02.2019. Добавлено ключевое слово "Экспорт".
// Функция используется при формировании данныха для PowerBI, общий модуль бит_PowerBIПереопределяемый.
Функция ПолучитьТекстЗапроса(КоличествоИнтервалов) Экспорт
...
// бит_Финанс 26.02.2019. Добавлено ключевое слово "Экспорт".
// Процедура используется при формировании данныха для PowerBI, общий модуль бит_PowerBIПереопределяемый.
Процедура УстановитьПараметры(ПараметрыОтчета, Схема, КомпоновщикНастроек) Экспорт
