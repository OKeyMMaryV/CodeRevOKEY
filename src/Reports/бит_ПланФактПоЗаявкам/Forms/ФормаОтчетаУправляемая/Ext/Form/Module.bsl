...
Процедура ПриОткрытии(Отказ)
	...
	// Ограничение типа для массивов счетов
	МассивТипов = Новый Массив;
	МассивТипов.Добавить(Тип("ПланСчетовСсылка.Хозрасчетный")); 
	ОписаниеТиповПвхХоз = Новый ОписаниеТипов(МассивТипов);
	Отчет.МассивСчетовБанк.ТипЗначения  = ОписаниеТиповПвхХоз;
	Отчет.МассивСчетовКасса.ТипЗначения = ОписаниеТиповПвхХоз;
...
// Процедура - обработчик события "ОбработкаРасшифровки" поля ввода "Результат".
// 
&НаКлиенте
Процедура РезультатОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
	
	ДополнительныеПунктыМеню = Новый СписокЗначений();
	ДополнительныеПунктыМеню.Добавить("бит_ОплатаЗаявок", "Оплата заявок");
...
Процедура ЗаполнитьДополнительныеСписки()
	...
	фСписокПараметровНаФорме.Добавить("МассивСчетовБанк");
	фСписокПараметровНаФорме.Добавить("МассивСчетовКасса");
