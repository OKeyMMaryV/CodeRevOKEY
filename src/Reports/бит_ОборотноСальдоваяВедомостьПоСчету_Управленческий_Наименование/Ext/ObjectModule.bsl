...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	РегистрационныеДанные.Вставить("Наименование", "Оборотно-сальдовая ведомость по счету (управленческий) + наименование счета");
	РегистрационныеДанные.Вставить("БезопасныйРежим", Истина);
	РегистрационныеДанные.Вставить("Версия", "1.0");
	
	РегистрационныеДанные.Вставить("Вид", "ДополнительныйОтчет");
	
	РегистрационныеДанные.Вставить("Информация", "Оборотно-сальдовая ведомость по счету (управленческий) + наименование счета");
	...
	строкаКоманды.Представление = "Оборотно-сальдовая ведомость по счету (управленческий) + наименование счета";
