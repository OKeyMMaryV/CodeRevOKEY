...
Функция ПолучитьВиртуальныеСтрокиРасшифровки(ИмяФормы, СтруктураОтчета, Раздел, ДанныеРаздела,
	...
	Если ИмяФормы = "ФормаОтчета2019Кв1" Тогда
		...
		Если Раздел = "ПолеТабличногоДокументаОИК" Тогда
			ДобавитьВиртуальныеСтрокиРасшифровкиОИК2019(ДанныеРаздела);
		КонецЕсли;
		
		Если Раздел = "ПолеТабличногоДокументаОДДС" Тогда
			ДобавитьВиртуальныеСтрокиРасшифровкиОДДС2019(ДанныеРаздела);
		КонецЕсли;
...
Процедура ДобавитьВиртуальныеСтрокиРасшифровкиБаланс2019(ИмяФормы, Раздел, ДанныеРаздела,
	...
	СписокФиксированныхСтрок.Добавить("11101", "Нематериальные активы в организации");
	СписокФиксированныхСтрок.Добавить("11102", "Приобретение нематериальных активов");
	ВнестиВиртуальныеСтрокиРасшифровкиБаланс2019(ИмяФормы, ДанныеРаздела, ДеревоНастройкиСостава,
		ПрефиксВиртуальнойСтроки, СписокФиксированныхСтрок, ПрефиксМногострочнойЧасти);
...
Процедура ДобавитьВиртуальныеСтрокиРасшифровкиОФР2019(ИмяФормы, Раздел, ДанныеРаздела,
	...
	Иначе
		...
		СписокФиксированныхСтрок = Новый СписокЗначений;
	КонецЕсли;
	ВнестиВиртуальныеСтрокиРасшифровкиОФР2019(ИмяФормы, ДанныеРаздела, ДеревоНастройкиСостава,
		ПрефиксВиртуальнойСтроки, СписокФиксированныхСтрок, ПрефиксМногострочнойЧасти);
...
Процедура ДобавитьВиртуальныеСтрокиРасшифровкиОИК2019(ДанныеРаздела)
	...
	ПараметрыВиртуальнойСтроки.ОграничениеПоКоличеству = 3;
	...
	ПараметрыВиртуальнойСтроки.ОграничениеПоКоличеству = 2;
	ВнестиВиртуальныеСтрокиРасшифровкиОИК2019(ПараметрыВиртуальнойСтроки);
...
Процедура ДобавитьВиртуальныеСтрокиРасшифровкиОДДС2019(ДанныеРаздела)
...
Процедура ВнестиВиртуальныеСтрокиРасшифровкиБаланс2019(ИмяФормы, ДанныеРаздела, ДеревоНастройкиСостава,
	ПрефиксВиртуальнойСтроки,СтруктураФиксированныхСтрок = Неопределено, ПрефиксМногострочнойЧасти)
	...
	ТаблицаЗначимости.Сортировать("Графа4 Убыв, Графа5 Убыв, Графа6 Убыв, Графа2");
	КоличествоСтрокДляВыгрузки = Мин(3, ТаблицаЗначимости.Количество());
...
Процедура ВнестиВиртуальныеСтрокиРасшифровкиОФР2019(ИмяФормы, ДанныеРаздела, ДеревоНастройкиСостава,
	ПрефиксВиртуальнойСтроки, СтруктураФиксированныхСтрок = Неопределено, ПрефиксМногострочнойЧасти)
	...
	ТаблицаЗначимости.Сортировать("Графа4 Убыв, Графа5 Убыв, Графа2");
	КоличествоСтрокДляВыгрузки = Мин(3, ТаблицаЗначимости.Количество());
...
Процедура ВнестиВиртуальныеСтрокиРасшифровкиОИК2019(ПараметрыВиртуальнойСтроки)
	...
	ТаблицаЗначимости.Сортировать("Графа8 Убыв, Графа1");
	КоличествоСтрокДляВыгрузки = Мин(ОграничениеПоКоличеству, ТаблицаЗначимости.Количество());
...
Процедура ВнестиВиртуальныеСтрокиРасшифровкиОДДС2019(ПараметрыВиртуальнойСтроки)
	...
	ТаблицаЗначимости.Сортировать("Графа3 Убыв, Графа4 Убыв, Графа1");
	КоличествоСтрокДляВыгрузки = Мин(ОграничениеПоКоличеству, ТаблицаЗначимости.Количество());
...
Функция ПроверитьВозможностьВыгрузки(ИмяФормы, СтруктураРеквизитовФормы, ДанныеОтчета,
	...
	Если ИмяФормы = "ФормаОтчета2019Кв1" Тогда
		Если НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.АдрМН) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(РезультатВыгрузки,
				"Не указан адрес местонахождения организации", "Баланс", "ОргПочтАдрес");
			СтатусПроверки = Ложь;
		КонецЕсли;
...
Процедура ПроверитьОсновныеРеквизитыОрганизации(СтатусПроверки, СтруктураРеквизитовФормы, ДанныеОтчета,
	...
	Если НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.ИННОрг) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(РезультатВыгрузки,
			"Не указан ИНН организации", "Баланс", "ОргИНН");
		СтатусПроверки = Ложь;
	...
	ИначеЕсли НЕ РегламентированнаяОтчетностьВызовСервера.ИННСоответствуетТребованиямНаСервере(
		...
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(РезультатВыгрузки,
			"Указан некорректный ИНН юридического лица", "Баланс", "ОргИНН");
		СтатусПроверки = Ложь;
	...
	Если НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.КППОрг) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(РезультатВыгрузки,
			"В справочнике ""Организации"" для текущей организации не указан КПП, необходимый для формирования файла выгрузки",
			"Баланс");
		СтатусПроверки = Ложь;
		
	ИначеЕсли СтрДлина(ПараметрыВыгрузки.КППОрг) <> 9 Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(РезультатВыгрузки,
			"В справочнике ""Организации"" для текущей организации указан некорректный КПП, необходимый для формирования файла выгрузки",
			"Баланс");
		СтатусПроверки = Ложь;
...
Процедура ПроверитьРеквизитыАудитора(СтатусПроверки, СтруктураРеквизитовФормы, ДанныеОтчета,
	...
	Если НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.ПрАудит) Тогда
		РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(РезультатВыгрузки,
			"Не указан признак прохождения обязательного аудита",
			"Баланс", "АудитДа");
		СтатусПроверки = Ложь;
		Возврат;
	КонецЕсли;
	...
	Если ПараметрыВыгрузки.АудиторЮЛ Тогда
		Если НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.АудитНаимОрг) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(РезультатВыгрузки,
				"Не указано наименование аудиторской организации",
				"Баланс", "НаимАудитора");
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.АудитИННЮЛ) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(РезультатВыгрузки,
				"Не указан ИНН аудиторской организации",
				"Баланс", "АудиторИНН");
			СтатусПроверки = Ложь;
		...
		ИначеЕсли НЕ РегламентированнаяОтчетностьВызовСервера.ИННСоответствуетТребованиямНаСервере(
			...
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(РезультатВыгрузки,
				"Указан некорректный ИНН аудиторской организации",
				"Баланс", "АудиторИНН");
			СтатусПроверки = Ложь;
		...
		Если НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.АудитОГРН) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(РезультатВыгрузки,
				"Не указан ОГРН аудиторской организации",
				"Баланс", "АудиторОГРН");
			СтатусПроверки = Ложь;
			
		ИначеЕсли СтрДлина(ПараметрыВыгрузки.АудитОГРН) <> 13 Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(РезультатВыгрузки,
				"Указан некорректный ОГРН аудиторской организации",
				"Баланс", "АудиторОГРН");
			СтатусПроверки = Ложь;
	...
	Если ПараметрыВыгрузки.АудиторИП Тогда
		...
		Если НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.АудитФамилия) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(РезультатВыгрузки,
				"Не указана фамилия индивидуального аудитора",
				"Баланс", "НаимАудитора");
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если НЕ ЗначениеЗаполнено(ПараметрыВыгрузки.АудитИмя) Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(РезультатВыгрузки,
				"Не указано имя индивидуального аудитора",
				"Баланс", "НаимАудитора");
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если УказанНекорректныйИНН Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(РезультатВыгрузки,
				"Указан некорректный ИНН индивидуального аудитора",
				"Баланс", "АудиторИНН");
			СтатусПроверки = Ложь;
		КонецЕсли;
		...
		Если УказанНекорректныйОГРН Тогда
			РегламентированнаяОтчетность.СообщитьВТаблицуСообщений(РезультатВыгрузки,
				"Указан некорректный ОГРНИП индивидуального аудитора",
				"Баланс", "АудиторОГРН");
			СтатусПроверки = Ложь;
		КонецЕсли;
