...
Функция ПечатьСразу(Объект, ИмяФормы) Экспорт
	Возврат ПечатьСразу_НевозможностьПечати(Объект);
КонецФункции

Функция СформироватьМакет(Объект, ИмяФормы) Экспорт
	Возврат СформироватьМакет_НевозможностьПечати(Объект);
КонецФункции
...
Функция ПечатьСразу_НевозможностьПечати(Объект)
	ПечатнаяФорма = СформироватьМакет_НевозможностьПечати(Объект);
...
Функция СформироватьМакет_НевозможностьПечати(Объект)
...
Функция ПроверитьДокументСВыводомВТаблицу_Форма2019_1(Данные, УникальныйИдентификатор)
	...
	Если Не ЗначениеЗаполнено(Титульная.ФормРеорг) Тогда 
		ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Не указан код формы реорганизации на титульной странице", "Титульная", "ФормРеорг"));
	КонецЕсли;
	Если Титульная.ФормРеорг <> "0" Тогда
		...
		КонецЕсли;
	Иначе
		Если Не РегламентированныеДанныеКлиентСервер.ИННСоответствуетТребованиям(Титульная.ИННРеорг, Истина, "") Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Неправильно указан ИНН реорганизованной организации на титульной странице", "Титульная", "ИННРеорг"));
		КонецЕсли;
		Если Не РегламентированныеДанныеКлиентСервер.КППСоответствуетТребованиям(Титульная.КППРеорг, "") Тогда 
			ТаблицаОшибок.Добавить(Документы.УведомлениеОСпецрежимахНалогообложения.ПолучитьПустуюСтруктуруНавигацииПоОшибкам("Неправильно указан КПП реорганизованной организации на титульной странице", "Титульная", "КППРеорг"));
		КонецЕсли;
	КонецЕсли;
