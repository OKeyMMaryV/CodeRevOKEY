...
Процедура Проверить(Команда)
	...
	"ru='Проверка контрольных соотношений в форме отчета, утвержденной приказом ФНС России от 02.03.2016 № ММВ-7-3/115@ (в редакции приказа ФНС России от 19.12.2019 № ММВ-7-3/639@), будет реализована в будущих версиях программы'");
	Сообщение.Сообщить();
