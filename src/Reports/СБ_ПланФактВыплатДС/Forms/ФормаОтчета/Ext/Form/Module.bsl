...
Процедура РезультатОбработкаРасшифровки(Элемент, Расшифровка, СтандартнаяОбработка)
	...
	ПараметрыФормы = Новый Структура("ВидРасшифровки, АдресНастроек, СформироватьПриОткрытии, ИДРасшифровки, ЗаполняемыеНастройки, МассивПолейРасшифровки",
			                                 1, ДанныеРасшифровки, Истина, "СБ_ПланФактВыплатДС", ЗаполняемыеНастройки, ПолучитьМассивПолейРасшифровки(Расшифровка));
	ОткрытьФорму("Отчет.СБ_ПланФактВыплатДС.Форма.Рашифровка", ПараметрыФормы,, Истина);
...
Функция ПолучитьПараметрыРасшифровки(Расшифровка)
	...
	СписокПунктовМеню.Добавить("СБ_ПланФактВыплатДС");
...
&НаСервере
Функция ПолучитьМассивПолейРасшифровки(Расшифровка)	//МассивПолейРасшифровки = бит_ОтчетыСервер.ПолучитьМассивПолейРасшифровки(Расшифровка, ПолучитьИзВременногоХранилища(ДанныеРасшифровки).ДанныеРасшифровки, Истина);
	ДанныеОбъекта = ПолучитьИзВременногоХранилища(ДанныеРасшифровки);
