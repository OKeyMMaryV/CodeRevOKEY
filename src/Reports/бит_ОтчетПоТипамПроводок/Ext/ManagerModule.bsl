...
Процедура ЗаполнитьДополнительныеСписки(СписокПараметровНаФорме) Экспорт
	...
	СписокПараметровНаФорме.Добавить("РегистрБухгалтерии", "РегистрБухгалтерии");
	СписокПараметровНаФорме.Добавить("Организация", "Организация");
	СписокПараметровНаФорме.Добавить("ОтображатьПустыеКолонки", "ОтображатьПустыеКолонки");
