...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	// Определим поддерживающую версию
	// ++ БП 
	Таблица = бит_ЛицензированиеБФКОРП.ПолучитьТаблицуВерсий();
	// -- БП 
	ТекущаяВерсия = " " + Таблица.Найти(Константы.бит_ТекущаяВерсияПродукта.Получить(),"Ключ").Представление;
