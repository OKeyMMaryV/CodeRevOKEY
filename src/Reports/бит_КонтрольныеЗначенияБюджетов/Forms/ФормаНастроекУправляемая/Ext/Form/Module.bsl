...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	МетаданныеОбъекта = Метаданные.Отчеты.бит_КонтрольныеЗначенияБюджетов;
...
Процедура КомандаЗавершитьРедактирование(Команда)
	...
	//ОКЕЙ Поздняков А.С. (СофтЛаб) Начало 2020-10-15 (#3918)
	ПользовательскиеНастройкиМодифицированы = Ложь;
	//ОКЕЙ Поздняков А.С. (СофтЛаб) Конец 2020-10-15 (#3918)
