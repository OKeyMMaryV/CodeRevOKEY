...
Процедура УстановитьДоступностьОбластей(Форма, ИмяРаздела)
	...
	ИначеЕсли ИмяРаздела = "Приложение1" Тогда
		...
		ВариантОбработкиЗначенияНалоговойБазы = ВариантОбработкиЗначенияНалоговойБазы_Приложение1(КодВидаПТ);
...
Функция КБКПоКодуВидаПодакцизногоТовара(КодВидаПодакцизногоТовара)
	...
	Если СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета >= '20200101' Тогда
		...
		ИначеЕсли ТекЗнач = "273" ИЛИ ТекЗнач = "286" ИЛИ ТекЗнач = "287" ИЛИ ТекЗнач = "288" Тогда
		...
		ИначеЕсли ТекЗнач = "294" ИЛИ ТекЗнач = "295" ИЛИ ТекЗнач = "296" ИЛИ ТекЗнач = "297" Тогда
			// Для кодов 294, 295, 296, 297 КБК отсутствует.
			Возврат "";
		КонецЕсли;
...
&НаКлиентеНаСервереБезКонтекста
Функция ВариантОбработкиЗначенияНалоговойБазы_Приложение1(КодВидаПодакцизногоТовара)
	
	ТекЗнач = СокрЛП(КодВидаПодакцизногоТовара);
	
	МасЗнач = СтрРазделить("111,121,140,150,160,161,162,163,130,164,165,170,224,231,291,292,293", ",");
	Если МасЗнач.Найти(ТекЗнач) <> Неопределено Тогда
		// Значение недоступно для редактирования вручную, авторассчитывается.
		Возврат 4;
	КонецЕсли;
	
	МасЗнач = СтрРазделить("232,271,272,284,285,310,320,330", ",");
	Если МасЗнач.Найти(ТекЗнач) <> Неопределено Тогда
...
Процедура СформироватьСлужебныеДанные()
	...
	СоответствиеКБК.Вставить("111"	,"18210302011011000110");		// этиловый спирт пищевой
	СоответствиеКБК.Вставить("121"	,"18210302012011000110");		// этиловый спирт непищевой
	СоответствиеКБК.Вставить("130"	,"18210302013011000110");		// дистиллят коньячный
	СоответствиеКБК.Вставить("140"	,"18210302011011000110");		// этиловый спирт-сырец пищевой
	СоответствиеКБК.Вставить("150"	,"18210302012011000110");		// этиловый спирт-сырец непищевой
	СоответствиеКБК.Вставить("160"	,"18210302011011000110");		// этиловый спирт неденатурированный
	СоответствиеКБК.Вставить("161"	,"18210302013011000110");		// дистиллят винный
	СоответствиеКБК.Вставить("162"	,"18210302013011000110");		// дистиллят виноградный
	СоответствиеКБК.Вставить("163"	,"18210302013011000110");		// дистиллят плодовый
	СоответствиеКБК.Вставить("164"	,"18210302013011000110");		// дистиллят кальвадосный
	СоответствиеКБК.Вставить("165"	,"18210302013011000110");		// дистиллят висковый
	СоответствиеКБК.Вставить("170"	,"18210302012011000110");		// этиловый спирт непищевой неденатурированный
	СоответствиеКБК.Вставить("224"	,"18210302110011000110");		// алкогольная продукция свыше 9%
	СоответствиеКБК.Вставить("231"	,"18210302130011000110");		// алкогольная продукция до 9%
	СоответствиеКБК.Вставить("232"	,"18210302120011000110");		// сидр пуаре медовуха
	СоответствиеКБК.Вставить("310"	,"18210302100011000110");		// пиво безалкогольное
	СоответствиеКБК.Вставить("320"	,"18210302100011000110");		// пиво до 9%
	СоответствиеКБК.Вставить("330"	,"18210302100011000110");		// пиво свыше 9%
	СоответствиеКБК.Вставить(""		,"");
	
	Если ДанныеКС.ГодОтчета > 2019 Тогда
		СоответствиеКБК.Вставить("273"	,"18210302090011000110");	// игристые вина
		СоответствиеКБК.Вставить("286"	,"18210302090011000110");	// вина
		СоответствиеКБК.Вставить("287"	,"18210302090011000110");	// фруктовые вина
		СоответствиеКБК.Вставить("288"	,"18210302090011000110");	// винные напитки
		СоответствиеКБК.Вставить("290"	,"18210302020011000110");	// спиртосодержащая продукция
		СоответствиеКБК.Вставить("294"	,"ОжидаетсяПубликация!");	// виноград
		СоответствиеКБК.Вставить("295"	,"ОжидаетсяПубликация!");	// виноматериалы
		СоответствиеКБК.Вставить("296"	,"ОжидаетсяПубликация!");	// виноградное сусло
		СоответствиеКБК.Вставить("297"	,"ОжидаетсяПубликация!");	// фруктовое сусло
	КонецЕсли;
	
	Если ДанныеКС.ГодОтчета <= 2019 Тогда
		СоответствиеКБК.Вставить("271"	,"18210302090011000110");	// игристые вина негеографические
		СоответствиеКБК.Вставить("272"	,"18210302350011000110");	// игристые вина географические
		СоответствиеКБК.Вставить("284"	,"18210302090011000110");	// вина негеографические
		СоответствиеКБК.Вставить("285"	,"18210302340011000110");	// вина географические
		СоответствиеКБК.Вставить("291"	,"18210302020011000110");	// спиртосодержащая продукция парфюмерная
		СоответствиеКБК.Вставить("292"	,"18210302020011000110");	// спиртосодержащая продукция бытовая
		СоответствиеКБК.Вставить("293"	,"18210302020011000110");	// спиртосодержащая продукция прочая
	КонецЕсли;
	
	ДанныеКС.Вставить("СоответствиеКБК", СоответствиеКБК);
	
	Если ДанныеКС.ГодОтчета > 2019 Тогда
		СтрокаКодовПТСПересчетом	= ",111,121,130,140,150,160,161,162,163,164,165,170,224,231,290";
		СтрокаКодовПТБезПересчета	= ",232,273,286,287,288,294,295,296,297,310,320,330";
	КонецЕсли;
...
Процедура ПроверкаКС_4_03(СтруктураРезультата)
	...
	Заголовки.Вставить("Условие"			, 
		...
		НСтр("ru='заполнен, код показателя в гр.1 = 10001, 10006-10012, 10020, 10022 или не заполнен, год <= 2019'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='2019'"));
	...
	Заголовки.Вставить("Раздел"				, НСтр("ru='Приложение 1'"));
	Заголовки.Вставить("Условие"			, 
		НСтр("ru='Код подакцизного товара в стр.010 Приложения 1 = 232, 273, 286, 287, 288, 294, 295, 296, 297, 310, '") +
		НСтр("ru='320, 330 или не заполнен, код показателя в гр.1 = 10001, 10006-10012, 10020, 10022 - 10026 или не '") +
		НСтр("ru='заполнен, год > 2019'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='2020'"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru='Проверка Приложения 1 (КС 4.3 в редакции 2020г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru='Гр.4 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.1 Раздела 2 по кодам подакцизных '") +
	...
	Если Документирование ИЛИ ДанныеКС.ГодОтчета <= 2019 Тогда
		Возврат;
	КонецЕсли;
...
Процедура ПроверкаКС_4_04(СтруктураРезультата)
	...
	Заголовки.Вставить("Условие"			, 
		НСтр("ru='Код подакцизного товара в стр.010 Приложения 1 = 232, 271, 272, 284, 285, 310, 320, 330 или не '") +
		НСтр("ru='заполнен, код показателя в гр.1 = 20001-20015 или не заполнен, год <= 2019'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='2019'"));
	...
	Заголовки.Вставить("Условие"			, 
		НСтр("ru='Код подакцизного товара в стр.010 Приложения 1 = 232, 273, 286, 287, 288, 294, 295, 296, 297, 310, '") +
		НСтр("ru='320, 330 или не заполнен, код показателя в гр.1 = 20001-20015 или не заполнен, год > 2019'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='2020'"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru='Проверка Приложения 1 (КС 4.4 в редакции 2020г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru='Гр.4 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.2 Раздела 2 по кодам подакцизных '") +
...
Процедура ПроверкаКС_4_05(СтруктураРезультата)
	...
	Заголовки.Вставить("Условие"			, 
		НСтр("ru='Код подакцизного товара в стр.010 Приложения 1 = 232, 271, 272, 284, 285, 310, 320, 330 или не '") +
		НСтр("ru='заполнен, код показателя в гр.1 = 30001-30005, 30008-30010, 30012 или не заполнен, год <= 2019'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='2019'"));
	...
	Заголовки.Вставить("Условие"			, 
		НСтр("ru='Код подакцизного товара в стр.010 Приложения 1 = 232, 273, 286, 287, 288, 294, 295, 296, 297, 310, '") +
		НСтр("ru='320, 330 или не заполнен, код показателя в гр.1 = 30001-30003, 30008-30016 или не заполнен, год > 2019'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='2020'"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru='Проверка Приложения 1 (КС 4.5 в редакции 2020г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
...
Процедура ПроверкаКС_4_06(СтруктураРезультата)
	...
	Заголовки.Вставить("Условие"			, 
		НСтр("ru='Код подакцизного товара в стр.010 Приложения 1 = 232, 271, 272, 284, 285, 310, 320, 330 или не '") +
		НСтр("ru='заполнен, код показателя в гр.1 = 50001-50011 или не заполнен, год <= 2019'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='2019'"));
	...
	Заголовки.Вставить("Условие"			, 
		НСтр("ru='Код подакцизного товара в стр.010 Приложения 1 = 232, 273, 286, 287, 288, 294, 295, 296, 297, 310, '") +
		НСтр("ru='320, 330 или не заполнен, код показателя в гр.1 = 50001-50011 или не заполнен, год > 2019'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='2020'"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru='Проверка Приложения 1 (КС 4.6 в редакции 2020г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru='Гр.4 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.5 Раздела 2 по кодам подакцизных товаров '") +
...
Процедура ПроверкаКС_4_07(СтруктураРезультата)
	...
	Заголовки.Вставить("Условие"			, 
		...
		НСтр("ru='10001, 10006-10012, 10020, 10022 или не заполнен, год <= 2019'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='2019'"));
	...
	Заголовки.Вставить("Условие"			, 
		НСтр("ru='Код подакцизного товара в стр.010 Приложения 1 = 111, 121, 130, 140, 150, 160, 161, 162, '") +
		НСтр("ru='163, 164, 165, 170, 224, 231, 290 или не заполнен, код показателя в гр.1 = '") +
		НСтр("ru='10001, 10006-10012, 10020, 10022 - 10026 или не заполнен, год > 2019'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='2020'"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru='Проверка Приложения 1 (КС 4.7 в редакции 2020г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru='Гр.5 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.1 Раздела 2 по кодам подакцизных '") +
...
Процедура ПроверкаКС_4_08(СтруктураРезультата)
	...
	Заголовки.Вставить("Условие"			, 
		НСтр("ru='Код подакцизного товара в стр.010 Приложения 1 = 111, 121, 130, 140, 150, 160, 161, 162, '") +
		НСтр("ru='163, 164, 165, 170, 224, 231, 291, 292, 293 или не заполнен, код показателя в гр.1 = '") +
		НСтр("ru='20001-20015 или не заполнен, год <= 2019'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='2019'"));
	...
	Заголовки.Вставить("Условие"			, 
		...
		НСтр("ru='20001-20015 или не заполнен, год > 2019'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='2020'"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru='Проверка Приложения 1 (КС 4.8 в редакции 2020г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru='Гр.5 стр.010 Приложения 1 должна равняться гр.3 подраздела 2.2 Раздела 2 по кодам подакцизных '") +
		НСтр("ru='товаров 111, 121, 130, 140, 150, 160, 161, 162, 163, 164, 165, 170, 224, 231, 290 и '") +
...
Процедура ПроверкаКС_4_09(СтруктураРезультата)
	...
	Заголовки.Вставить("Условие"			, 
		НСтр("ru='Код подакцизного товара в стр.010 Приложения 1 = 111, 121, 130, 140, 150, 160, 161, 162, '") +
		НСтр("ru='163, 164, 165, 170, 224, 231, 291, 292, 293 или не заполнен, код показателя в гр.1 = '") +
		НСтр("ru='30001-30005, 30008-30010, 30012 или не заполнен, год <= 2019'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='2019'"));
	...
	Заголовки.Вставить("Условие"			, 
		НСтр("ru='Код подакцизного товара в стр.010 Приложения 1 = 111, 121, 130, 140, 150, 160, 161, 162, '") +
		НСтр("ru='163, 164, 165, 170, 224, 231, 290 или не заполнен, код показателя в гр.1 = '") +
		НСтр("ru='30001-30003, 30008-30016 или не заполнен, год > 2019'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='2020'"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru='Проверка Приложения 1 (КС 4.9 в редакции 2020г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru='Гр.5 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.3 Раздела 2 по кодам подакцизных '") +
		НСтр("ru='товаров 111, 121, 130, 140, 150, 160, 161, 162, 163, 164, 165, 170, 224, 231, 290 и '") +
...
Процедура ПроверкаКС_4_10(СтруктураРезультата)
	...
	Заголовки.Вставить("Условие"			, 
		НСтр("ru='Код подакцизного товара в стр.010 Приложения 1 = 111, 121, 130, 140, 150, 160, 161, 162, '") +
		НСтр("ru='163, 164, 165, 170, 224, 231, 291, 292, 293 или не заполнен, код показателя в гр.1 = '") +
		НСтр("ru='50001-50011 или не заполнен, год <= 2019'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='2019'"));
	...
	Заголовки.Вставить("Условие"			, 
		...
		НСтр("ru='50001-50011 или не заполнен, год > 2019'"));
	Заголовки.Вставить("Комментарий"		, НСтр("ru='2020'"));
	Заголовки.Вставить("ТекстФормулы"		, НСтр("ru='Проверка Приложения 1 (КС 4.10 в редакции 2020г)'"));
	Заголовки.Вставить("Нарушение"			, НСтр("ru='ст.80 НК РФ'"));
	Заголовки.Вставить("ОписаниеКС"			, 
		НСтр("ru='Гр.5 стр.010 Приложения 1 должна равняться гр.2 подраздела 2.5 Раздела 2 по кодам подакцизных '") +
