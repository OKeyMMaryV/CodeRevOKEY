...
Процедура ЗаполнитьДополнительныеСписки()
	...
	фСписокПараметровНаФорме = Отчеты.бит_ПлатежныйКалендарь.ПараметрыНаФорме();
...
Процедура УправлениеВидимостьюДоступностью()
	...
	Элементы.РежимОстатков.Видимость 	   = Истина;	
	Элементы.РежимОстатков_УппКа.Видимость = Ложь;	
