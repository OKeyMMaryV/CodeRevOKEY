...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	//СБ_КазначействоКлиент.бит_РеестрПлатежейФормаСпискаПриОткрытии(ЭтаФорма);
	ИжТиСи_СВД_Сервер.ОК_ВывестиРеквизиты(ЭтаФорма, "Документ.бит_РеестрПлатежей.ФормаСпискаУправляемая");
	// -СБ. Широков Николай 
	...
	МетаданныеОбъекта = Метаданные.Документы.бит_РеестрПлатежей;
