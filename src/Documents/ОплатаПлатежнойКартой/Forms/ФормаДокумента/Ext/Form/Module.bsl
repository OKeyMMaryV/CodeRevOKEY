...
Процедура ПредставлениеВидОплатыНажатие(Элемент, СтандартнаяОбработка)
	...
	ПараметрыПередачи.Вставить("ок_ВидыПереводов" , Объект.ок_ВидыПереводов);
	ПараметрыПередачи.Вставить("ок_СтатьяДвиженияДенежныхСредств", Объект.ок_СтатьяДвиженияДенежныхСредств);
