...
Процедура ОбработкаЗаполнения(ДанныеЗаполнения, СтандартнаяОбработка)
	...
	Если Не ПолучитьФункциональнуюОпцию("РасширенныйФункционал") 
		...
		Или Не ПрименяетсяФСБУ25 Тогда
...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	УчетПроцентовПоОбязательствам.ЗаполнитьДанныеДисконтированияОбязательстваПоАренде(ЭтотОбъект, Отказ, РежимЗаписи);
...
Процедура ОбработкаПроведения(Отказ, РежимПроведения)
	...
	УчетОС.СформироватьДвиженияДанныеОПоступленииПредметыАренды(
		ТаблицаПредметыАренды, ТаблицаРеквизиты, Движения, Отказ);
