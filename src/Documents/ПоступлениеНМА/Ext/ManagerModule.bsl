...
Процедура ПодготовитьТаблицыДокументаДляЦелейПриобретенияРеализации(Запрос, Реквизиты)
	...
	|	,НематериальныеАктивы.ок_Период КАК Период,
	|	НематериальныеАктивы.ок_СтатьяОборотов КАК СтатьяОборотов, 
	|	НематериальныеАктивы.ок_СтатьяОборотов.ВидСтатьи КАК ВидСтатьи,
	|	НематериальныеАктивы.ок_ЦФО КАК ЦФО,
	|	НематериальныеАктивы.ок_Проект КАК Проект,
	|	НематериальныеАктивы.ок_Аналитика_2 КАК Аналитика_2		
...
Функция ТекстЗапросаВременныеТаблицыДокумента(НомераТаблиц)
	...
	//ОКЕЙ Лобанов В.И.(СофтЛаб) Начало 2018-07-19 (#3052)
	|	,ТаблицаНематериальныеАктивы.Период КАК Период,
	|	ТаблицаНематериальныеАктивы.СтатьяОборотов КАК СтатьяОборотов, 
	|	ТаблицаНематериальныеАктивы.ВидСтатьи КАК ВидСтатьи,
	|	ТаблицаНематериальныеАктивы.ЦФО КАК ЦФО,
	|	ТаблицаНематериальныеАктивы.Проект КАК Проект,
	|	ТаблицаНематериальныеАктивы.Аналитика_2 КАК Аналитика_2		
	//ОКЕЙ Лобанов В.И.(СофтЛаб) Конец 2018-07-19 (#3052)	
