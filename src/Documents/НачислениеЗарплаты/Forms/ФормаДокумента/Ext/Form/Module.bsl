...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Ключ.Пустая() Тогда
		...
		//ОКЕЙ Лобанов В.И.(СофтЛаб) Начало 2019-01-09 (исправления в релизе 3.0.64.54/3.1.38.5)
		...
		КонецЦикла;
		//ОКЕЙ Лобанов В.И.(СофтЛаб) Конец 2019-01-09 (исправления в релизе 3.0.64.54/3.1.38.5)		
