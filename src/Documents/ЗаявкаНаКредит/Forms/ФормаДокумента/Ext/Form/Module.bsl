...
Процедура НадписьСогласиеОбработкаНавигационнойСсылки(Элемент, НавигационнаяСсылкаФорматированнойСтроки, СтандартнаяОбработка)
	...
	ПараметрыФормы.Вставить("ОбъектыСогласия",   Банки);
	
	ОткрытьФорму("Документ.ЗаявкаНаКредит.Форма.СогласиеНаОбработкуДанных", ПараметрыФормы, ЭтотОбъект, Банки[0]);
...
Процедура УчредителиВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если Поле = Элементы.УчредителиУчредитель Тогда
		// Выбор из справочника осуществляется стандартно.
		Возврат;
	КонецЕсли;
...
Процедура ОбновитьДанныеРуководителяКакУчредителя()
	...
	СтрокаУчредителя.ДатаРождения = ФизическоеЛицо.ДатаРождения;
	СтрокаУчредителя.ИНН          = ФизическоеЛицо.ИНН;
	СтрокаУчредителя.Адрес        = КонтактнаяИнформацияПолеАдресПоПропискеФизическиеЛица;
	...
	СтрокаУчредителя.ПредставлениеДокумента = СтрСоединить(Подстроки, ", ");
...
Процедура УстановитьУсловноеОформление()
	...
	// Табличное поле Учредители.
	// Если не заполнены одна из колонок с данными об учредителях, то показываем соответствующий признак.
	
	// Дата рождения
	ЭлементУО = УсловноеОформление.Элементы.Добавить();

	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "УчредителиДатаРождения");

	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"Объект.Учредители.ДатаРождения", ВидСравненияКомпоновкиДанных.НеЗаполнено);
	...
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "УчредителиИНН");

	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"Объект.Учредители.ИНН", ВидСравненияКомпоновкиДанных.НеЗаполнено);
	...
	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "УчредителиПредставлениеДокумента");

	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"Объект.Учредители.ПредставлениеДокумента", ВидСравненияКомпоновкиДанных.НеЗаполнено);

	ЭлементУО.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Паспорт: <...>'"));


	// Адрес
	ЭлементУО = УсловноеОформление.Элементы.Добавить();

	КомпоновкаДанныхКлиентСервер.ДобавитьОформляемоеПоле(ЭлементУО.Поля, "УчредителиАдрес");

	ОбщегоНазначенияКлиентСервер.ДобавитьЭлементКомпоновки(ЭлементУО.Отбор,
		"Объект.Учредители.Адрес", ВидСравненияКомпоновкиДанных.НеЗаполнено);

	ЭлементУО.Оформление.УстановитьЗначениеПараметра("Текст", НСтр("ru = 'Адрес: <...>'"));
