...
Функция ТекстЗапросаДанныеДляПечатиСчетовФактур(НомераТаблиц, ЕстьПрослеживаемыеОС) Экспорт
...
Функция ТекстЗапросаТаблицаОС(НомераТаблиц)
	...
	ТекстЗапроса = "ВЫБРАТЬ
		...
		//ОК+ Аверьянова #2538 от 21.06.16 //исправление
		////izhtc-Kir 18.08.2015 (
		//|	ОсновныеСредства.Субконто КАК Субконто3,
		////izhtc-Kir 18.08.2015 )
...
Функция ТекстЗапросаСписаниеОстаточнойСтоимости(НомераТаблиц, ПараметрыПроведения, Реквизиты)
	...
	|	КОНЕЦ КАК Субконто,
	//izhtc-Kir 18.08.2015 (
	|	ТаблицаОС.Субконто3 КАК Субконто3,
	//izhtc-Kir 18.08.2015 )	
	|	ВЫБОР
...
Функция ТекстЗапросаРеализацияНДС(НомераТаблиц, ПараметрыПроведения, Реквизиты)
	...
	//ОК+ Аверьянова #2538 от 21.06.16 //исправление
	////izhtc-Kir 18.08.2015 (
	//|	ТаблицаОС.Субконто КАК Субконто3,
	////izhtc-Kir 18.08.2015 )
	|	ТаблицаОС.Субконто3 КАК Субконто3,
	//ОК-	
