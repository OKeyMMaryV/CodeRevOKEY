...
Функция ПодготовитьЗапрос(СтруктураПараметров, СчетаИсключения)
	...
	|	ЛОЖЬ КАК ЭтоУниверсальныйДокумент,
	|	ЛОЖЬ КАК ЭтоКорректировочныйДокумент,
...
Функция ПолучитьТекстЗапросаДляФормированияПечатнойФормыАктСверки()
	...
	|	АктСверкиВзаиморасчетов.ОК_Флаг_СписокКонтрагентов,
	//ижтиси, шадрин, 17.08.2015)	
	...
	|	МАКСИМУМ(ОК_Флаг_СписокКонтрагентов),
	//ижтиси, шадрин, 18.08.2015)	
...
Функция ПечатьАктаСверки(МассивОбъектов, ОбъектыПечати, ПараметрыПечати)
	...
	Пока Шапка.Следующий() Цикл
		...
		//ижтиси, шадрин, 17.08.2015(
		ОК_Флаг_СписокКонтрагентов = Шапка.ОК_Флаг_СписокКонтрагентов;
		//ижтиси, шадрин, 17.08.2015)	
		...
		Если НЕ ОК_Флаг_СписокКонтрагентов Тогда
