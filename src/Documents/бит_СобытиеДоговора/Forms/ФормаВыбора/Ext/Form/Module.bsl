...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("Договор") Тогда
		...
		НовыйЭлемент.ЛевоеЗначение = Новый ПолеКомпоновкиДанных("Договор");
		НовыйЭлемент.ВидСравнения  = ВидСравненияКомпоновкиДанных.Равно;
		НовыйЭлемент.ПравоеЗначение = ?(ТипЗнч(Параметры.Договор) = Тип("ДокументСсылка.бит_ПроектДоговора"), бит_ДоговораСервер.НайтиДоговорКонтрагентаПоПроектуДоговора(Параметры.Договор), Параметры.Договор.бит_ПроектДоговора);
		НовыйЭлемент.Применение    = ТипПримененияОтбораКомпоновкиДанных.Элементы;
