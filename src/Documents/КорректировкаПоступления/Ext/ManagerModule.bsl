...
Функция ТекстЗапросаДанныеДляПечатиКорректировочныхСчетовФактур(НомераТаблиц) Экспорт
	...
	|		КорректировкаПоступленияСведенияПрослеживаемости.Ссылка В
	|				(ВЫБРАТЬ
	|					ТаблицаДокумента.Ссылка.ДокументПоступления
	|				ИЗ
	|					ТаблицаДокумента)
	|	
	|	ОБЪЕДИНИТЬ ВСЕ
	...
	|
	|СГРУППИРОВАТЬ ПО
	|	ЕСТЬNULL(КлассификаторТНВЭД.ЕдиницаИзмерения.Наименование, """"),
	...
	Возврат ТекстЗапроса + ОбщегоНазначенияБПВызовСервера.ТекстРазделителяЗапросовПакета();		
	// ОКЕЙ Смирнов М.В. (СофтЛаб) Конец 2021-06-10 (#4208)
...
//ОКЕЙ Лобанов В.И.(СофтЛаб) Начало 2018-07-21 (#3050)	   
	|	ПоступлениеТоваровУслугТовары.ок_Период КАК ок_Период,
	|	ПоступлениеТоваровУслугТовары.ок_СтатьяОборотов КАК ок_СтатьяОборотов, 
	|	ПоступлениеТоваровУслугТовары.ок_ЦФО КАК ок_ЦФО,
	|	ПоступлениеТоваровУслугТовары.ок_Проект КАК ок_Проект,
...
//ОКЕЙ Лобанов В.И.(СофтЛаб) Начало 2018-07-21 (#3050)	   
	|	ПоступлениеТоваровУслугУслуги.ок_Период КАК ок_Период,
	|	ПоступлениеТоваровУслугУслуги.ок_СтатьяОборотов КАК ок_СтатьяОборотов, 
	|	ПоступлениеТоваровУслугУслуги.ок_ЦФО КАК ок_ЦФО,
	|	ПоступлениеТоваровУслугУслуги.ок_Проект КАК ок_Проект,
...
//ОКЕЙ Лобанов В.И.(СофтЛаб) Начало 2018-07-21 (#3050)	   
	|	ПоступлениеТоваровУслугАгентскиеУслуги.ок_Период КАК ок_Период,
	|	ПоступлениеТоваровУслугАгентскиеУслуги.ок_СтатьяОборотов КАК ок_СтатьяОборотов, 
	|	ПоступлениеТоваровУслугАгентскиеУслуги.ок_ЦФО КАК ок_ЦФО,
	|	ПоступлениеТоваровУслугАгентскиеУслуги.ок_Проект КАК ок_Проект,
	|	ПоступлениеТоваровУслугАгентскиеУслуги.ок_Аналитика_2 КАК ок_Аналитика_2,		
//ОКЕЙ Лобанов В.И.(СофтЛаб) Конец 2018-07-21 (#3050)	
	|	ПоступлениеТоваровУслугАгентскиеУслуги.Номенклатура,
...
//ОКЕЙ Лобанов В.И.(СофтЛаб) Начало 2018-07-21 (#3050)	   
		|	ПоступлениеТоваровУслугОборудование.ок_Период КАК ок_Период,
		|	ПоступлениеТоваровУслугОборудование.ок_СтатьяОборотов КАК ок_СтатьяОборотов, 
		|	ПоступлениеТоваровУслугОборудование.ок_ЦФО КАК ок_ЦФО,
		|	ПоступлениеТоваровУслугОборудование.ок_Проект КАК ок_Проект,
		|	ПоступлениеТоваровУслугОборудование.ок_Аналитика_2 КАК ок_Аналитика_2,		
//ОКЕЙ Лобанов В.И.(СофтЛаб) Конец 2018-07-21 (#3050)		
		|	ПоступлениеТоваровУслугОборудование.Номенклатура,
	...
	//ОКЕЙ Назаренко Д.В. (СофтЛаб) Начало 2021-07-29 (#4214)
	ЗаполнитьСведенияПрослеживаемости(Объект, Объект.ДокументПоступления);
	//ОКЕЙ Назаренко Д.В. (СофтЛаб) Конец 2021-07-29 (#4214) 
...
Функция ДоступнаКорректировкаБУиНУ(ДокументПоступления) Экспорт
	...
	ИначеЕсли ТипЗнч(ДокументПоступления) = Тип("ДокументСсылка.бит_ок_ОперацияАксапты") Тогда
		Результат = Истина;
...
Функция ПодготовитьПараметрыПроведения(ДокументСсылка, Отказ, ДоговорДляОтложенногоПроведения = Неопределено) Экспорт
	...
	//ОКЕЙ Назаренко Д.В. (СофтЛаб) Начало 2021-07-30 (#4214) 
	    ...
	    "Дата,СчетУчетаРасчетовСКонтрагентом,СчетУчетаРасчетовПоАвансам,СуммаВключаетНДС, ДатаВходящегоДокумента, НомерВходящегоДокумента",
	//ОКЕЙ Назаренко Д.В. (СофтЛаб) Конец 2021-07-30 (#4214) 
...
Функция ТекстЗапросаРеквизитыДокумента(НомераТаблиц)
	...
	|	Реквизиты.ок_КорректировкаТекущимГодом КАК ок_КорректировкаТекущимГодом,
...
Функция ТекстЗапросаВременныеТаблицыДокумента(НомераТаблиц, Реквизиты)
	...
	Если Реквизиты.ЕстьТовары Тогда
		...
		//ОКЕЙ Лобанов В.И.(СофтЛаб) Начало 2018-07-09 (#3050)
		...
		//ОКЕЙ Лобанов В.И.(СофтЛаб) Конец 2018-07-09 (#3050)		
...
Функция ТекстЗапросаВременныеТаблицыДокументаРасчетыВВалюте(НомераТаблиц, Реквизиты)
	...
	Если Реквизиты.ЕстьТовары Тогда
		...
		|	ТаблицаТовары.СчетРасчетов КАК СчетРасчетовСКомитентом,
		|	ТаблицаТовары.ЕстьВДокументеПоступления
		//ОКЕЙ Бублик А.А.(СофтЛаб) Начало 2020-10-08 (#3902)
		|	,ТаблицаТовары.ок_Период КАК Период,
		|	ТаблицаТовары.ок_СтатьяОборотов КАК СтатьяОборотов, 
		|	ТаблицаТовары.ок_СтатьяОборотов.ВидСтатьи КАК ВидСтатьи,
		|	ТаблицаТовары.ок_ЦФО КАК ЦФО,
		|	ТаблицаТовары.ок_Проект КАК Проект,
		|	ТаблицаТовары.ок_Аналитика_2 КАК Аналитика_2
		//ОКЕЙ Бублик А.А.(СофтЛаб) Конец 2020-10-08 (#3902)
		|ПОМЕСТИТЬ ТаблицаТовары
		|ИЗ
		|	Документ.КорректировкаПоступления.Товары КАК ТаблицаТовары
...
Функция ТекстЗапросаКорректировкаПоступления(НомераТаблиц, ПараметрыПроведения, Реквизиты)
	...
	Иначе
		...
		|	ТаблицаТовары.ЦФО,
		|	ТаблицаТовары.СтатьяОборотов,
		|	ТаблицаТовары.ВидСтатьи,
		|	ТаблицаТовары.Проект,
		|	ТаблицаТовары.Аналитика_2		
	...
	Иначе
		...
		|	ТаблицаУслуги.ЕстьВДокументеПоступления
		//ОКЕЙ Лобанов В.И.(СофтЛаб) Начало 2018-07-22 (#3050)
		|	,ТаблицаУслуги.Период,
		|	ТаблицаУслуги.ЦФО,
		|	ТаблицаУслуги.СтатьяОборотов,
		|	ТаблицаУслуги.ВидСтатьи,
		|	ТаблицаУслуги.Проект,
		|	ТаблицаУслуги.Аналитика_2		
		//ОКЕЙ Лобанов В.И.(СофтЛаб) Конец 2018-07-22 (#3050)		
		|ИЗ
	...
	Иначе
		...
		//ОКЕЙ Лобанов В.И.(СофтЛаб) Начало 2018-07-22 (#3050)
		|	,ТаблицаАгентскиеУслуги.Период,
		|	ТаблицаАгентскиеУслуги.ЦФО,
		|	ТаблицаАгентскиеУслуги.СтатьяОборотов,
		|	ТаблицаАгентскиеУслуги.ВидСтатьи,
		|	ТаблицаАгентскиеУслуги.Проект,
		|	ТаблицаАгентскиеУслуги.Аналитика_2		
		//ОКЕЙ Лобанов В.И.(СофтЛаб) Конец 2018-07-22 (#3050)		
		|ИЗ
...
Процедура ЗаполнитьСведенияПрослеживаемости(Объект, ДокументПоступления)
	...
	ИсходныеСведенияПрослеживаемости = ДокументПоступления.СведенияПрослеживаемости.Выгрузить();
	Объект.СведенияПрослеживаемости.Загрузить(ИсходныеСведенияПрослеживаемости);
...
Функция ТекстЗапросаПрослеживаемыеТовары(НомераТаблиц, ПараметрыПроведения, Реквизиты)
	...
	|			ТОГДА ВЫБОР
	|					КОГДА КорректировкаПоступленияТовары.СчетУчета.Забалансовый
	...
	|ИЗ
	|	Документ.КорректировкаПоступления.СведенияПрослеживаемости КАК КорректировкаПоступленияСведенияПрослеживаемости
	|		ПОЛНОЕ СОЕДИНЕНИЕ Документ.КорректировкаПоступления.Товары КАК КорректировкаПоступленияТовары
	...
	|			И КорректировкаПоступленияСведенияПрослеживаемости.ИдентификаторСтроки = КорректировкаПоступленияТовары.ИдентификаторСтроки
	|ГДЕ
	|	КорректировкаПоступленияСведенияПрослеживаемости.Ссылка = &ДокументПоступления
	|
	|СГРУППИРОВАТЬ ПО
	|	КорректировкаПоступленияСведенияПрослеживаемости.ИдентификаторСтроки,
	|	КорректировкаПоступленияТовары.Номенклатура,
	...
	|ВЫБРАТЬ
	|	КорректировкаПоступленияТовары.Номенклатура КАК Номенклатура,
	|	СУММА(ТаблицаТовары.СуммаРуб - ТаблицаТовары.СуммаНДСРуб) КАК СуммаБезНДС
	|ПОМЕСТИТЬ ВТ_СуммыБезНДС
	|ИЗ
	|	Документ.КорректировкаПоступления.Товары КАК КорректировкаПоступленияТовары
	|		ЛЕВОЕ СОЕДИНЕНИЕ ТаблицаТовары КАК ТаблицаТовары
	|		ПО КорректировкаПоступленияТовары.НомерСтроки = ТаблицаТовары.НомерСтроки
	|ГДЕ
	|	КорректировкаПоступленияТовары.Ссылка = &Ссылка
	...
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	|	ВТ_РНПТКорректировки.РНПТ КАК РНПТ,
	|	СУММА(ВЫБОР
	|			КОГДА ВТ_РНПТКорректировки.Количество - ЕСТЬNULL(ВТ_РНПТДокументПоступления.Количество, 0) > 0
	|				ТОГДА ВТ_РНПТКорректировки.Количество - ЕСТЬNULL(ВТ_РНПТДокументПоступления.Количество, 0)
	|			ИНАЧЕ 0
	|		КОНЕЦ) КАК КоличествоУвеличение,
	|	СУММА(ВЫБОР
	|			КОГДА ЕСТЬNULL(ВТ_РНПТДокументПоступления.Количество, 0) - ВТ_РНПТКорректировки.Количество > 0
	|				ТОГДА ЕСТЬNULL(ВТ_РНПТДокументПоступления.Количество, 0) - ВТ_РНПТКорректировки.Количество
	|			ИНАЧЕ 0
	|		КОНЕЦ) КАК КоличествоУменьшение,
	|	СУММА(ВЫБОР
	|			КОГДА ВТ_РНПТКорректировки.КоличествоПрослеживаемости - ЕСТЬNULL(ВТ_РНПТДокументПоступления.КоличествоПрослеживаемости, 0) > 0
	|				ТОГДА ВТ_РНПТКорректировки.КоличествоПрослеживаемости - ЕСТЬNULL(ВТ_РНПТДокументПоступления.КоличествоПрослеживаемости, 0)
	|			ИНАЧЕ 0
	|		КОНЕЦ) КАК КоличествоПрослеживаемостиУвеличение,
	|	СУММА(ВЫБОР
	|			КОГДА ЕСТЬNULL(ВТ_РНПТДокументПоступления.КоличествоПрослеживаемости, 0) - ВТ_РНПТКорректировки.КоличествоПрослеживаемости > 0
	|				ТОГДА ЕСТЬNULL(ВТ_РНПТДокументПоступления.КоличествоПрослеживаемости, 0) - ВТ_РНПТКорректировки.КоличествоПрослеживаемости
	|			ИНАЧЕ 0
	|		КОНЕЦ) КАК КоличествоПрослеживаемостиУменьшение,
	|	ВТ_РНПТКорректировки.Номенклатура КАК Номенклатура,
	|	ВТ_РНПТКорректировки.СтранаПроисхождения КАК СтранаПроисхождения
	|ПОМЕСТИТЬ ВТ_ПрослеживаемыеТоварыПредварительная
	|ИЗ
	|	ВТ_РНПТКорректировки КАК ВТ_РНПТКорректировки
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_РНПТДокументПоступления КАК ВТ_РНПТДокументПоступления
	...
	|
	|СГРУППИРОВАТЬ ПО
	|	ВТ_РНПТКорректировки.РНПТ,
	|	ВТ_РНПТКорректировки.Номенклатура,
	|	ВТ_РНПТКорректировки.СтранаПроисхождения
	|;
	|
	|////////////////////////////////////////////////////////////////////////////////
	|ВЫБРАТЬ
	...
	|ВЫБРАТЬ
	|	ВТ_РНПТКорректировки.Номенклатура КАК Номенклатура,
	|	ВТ_РНПТКорректировки.Количество КАК Количество,
	|	ВТ_РНПТКорректировки.РНПТ КАК РНПТ,
	|	ВТ_РНПТКорректировки.КоличествоПрослеживаемости КАК КоличествоПрослеживаемости,
	|	ВТ_РНПТКорректировки.ОтражениеВОтчетности КАК ОтражениеВОтчетности,
	|	ВТ_РНПТКорректировки.КодОперации КАК КодОперации,
	|	ВТ_РНПТКорректировки.ДокументОперации КАК ДокументОперации,
	|	ВТ_РНПТКорректировки.Контрагент КАК Контрагент,
	|	ВТ_РНПТКорректировки.ПериодОперации КАК ПериодОперации,
	|	ВТ_РНПТКорректировки.НомерДокумента КАК НомерДокумента,
	|	ВТ_РНПТКорректировки.ДатаДокумента КАК ДатаДокумента,
	|	ВТ_РНПТКорректировки.ТипДокументаВПрослеживаемости КАК ТипДокументаВПрослеживаемости,
	|	ЕСТЬNULL(ВТ_СуммыБезНДС.СуммаБезНДС, 0) КАК СуммаБезНДС
	|ИЗ
	|	ВТ_РНПТКорректировки КАК ВТ_РНПТКорректировки
	|		ЛЕВОЕ СОЕДИНЕНИЕ ВТ_СуммыБезНДС КАК ВТ_СуммыБезНДС
	|		ПО ВТ_РНПТКорректировки.Номенклатура = ВТ_СуммыБезНДС.Номенклатура";
