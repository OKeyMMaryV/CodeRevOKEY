...
Процедура ОбработкаПроведения(Отказ)
	...
	//Если ПодразделениеПолучатель.ОК_КонтрольОбъекта тогда
	...
	//																	ПодразделениеПолучатель,СпособОтраженияРасходовПоАмортизации,неопределено)
	//																	, Отказ, Заголовок,"подразделении-получателе");
	//Конецесли;																	
	////ОК Калинин М. 
...
Процедура ЗаполнитьПоДокументуОснованию(Основание)
	...
	ИначеЕсли ТипЗнч(Основание) = Тип("ДокументСсылка.ИнвентаризацияОС") Тогда
		...
		//ОК Калинин М. 030713 Формирование перемещений по МОЛ-ам
