...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ДокументОснование") Тогда
		...
		Если ЗначениеЗаполнено(Параметры.ДокументОснование) Тогда
			ДокОбъект = ДанныеФормыВЗначение(Объект, Тип("ДокументОбъект.бит_мто_ПередачаВОбеспечениеСоСклада"));
...
Процедура ПередЗаписью(Отказ, ПараметрыЗаписи)
	...
	Если ПараметрыЗаписи.РежимЗаписи = ПредопределенноеЗначение("РежимЗаписиДокумента.Проведение") Тогда
		КлючеваяОперация = "Проведениебит_мто_ПередачаВОбеспечениеСоСклада";
...
Процедура ЗаполнитьКэшЗначений()
	...
	ДокументЗаявкаНаПотребность = ДанныеФормыВЗначение(Объект, Тип("ДокументОбъект.бит_мто_ПередачаВОбеспечениеСоСклада"));
...
Процедура ДокументОснованиеПриИзмененииНаСервере()
	...
	Если ЗначениеЗаполнено(Объект.ДокументОснование) Тогда
		...
		СтрВозврата = бит_мто.ПроверитьВозможностьСозданияДокумента(Объект.ДокументОснование);
	
		Если НЕ СтрВозврата.Возможно Тогда
			
			Если ЗначениеЗаполнено(СтрВозврата.ТекстСообщения) Тогда
			
				ТекстСообщения = НСтр("ru = 'Заявка на потребность должна быть в статусе Утверждена!'");
