...
Функция ТекстЗапросаФормированиеКонтролируемыхСделок2012()
	...
	|	НЕ КонтрагентыКонтролируемыеПоОбщейСумме.ГоловнойКонтрагент ЕСТЬ NULL КАК ОснованиеКонтролируемости131,
	|	КонтролируемыеСделки.СделкаКонтролируетсяПоНДПИ КАК ОснованиеКонтролируемости132,
	...
	|	КонтролируемыеСделки.СделкаКонтролируетсяПоНалогуНаПрибыль КАК ОснованиеКонтролируемости134,
	|	КонтролируемыеСделки.СделкаКонтролируетсяПоРегистрацииВОЭЗ КАК ОснованиеКонтролируемости135,
	|	КонтролируемыеСделки.СделкаМорскогоМесторождения КАК ОснованиеКонтролируемости136,
	|	КонтролируемыеСделки.СделкаКонтролируетсяПоИнвестиционнымПроектам КАК ОснованиеКонтролируемости137,
	|	КонтролируемыеСделки.СделкаКонтролируетсяПоОсвобождениюНДС КАК ОснованиеКонтролируемости138,
	|	КонтролируемыеСделки.СделкаКонтролируетсяПоИнвестиционномуВычету КАК ОснованиеКонтролируемости139,
	|	КонтролируемыеСделки.СделкаКонтролируетсяПоДополнительномуДоходуОтСырья КАК ОснованиеКонтролируемости140,
	|	ВЫБОР
...
Функция ТекстЗапросаФормированиеКонтролируемыхСделок2019()
	...
	|	КОНЕЦ КАК СтоимостьВВалюте,
	|	КонтролируемыеСделки.КонтрагентЗарегистрированВРФ КАК КонтрагентЗарегистрированВРФ,
	|	КонтролируемыеСделки.СделкаКонтролируетсяПоРазнымСтавкамНалогаНаПрибыль КАК ОснованиеКонтролируемости131,
	|	КонтролируемыеСделки.СделкаКонтролируетсяПоНДПИ КАК ОснованиеКонтролируемости132,
	|	КонтролируемыеСделки.СделкаОблагаетсяЕНВД
	|		ИЛИ КонтролируемыеСделки.СделкаСПлательщикомЕСХН КАК ОснованиеКонтролируемости133,
	|	КонтролируемыеСделки.СделкаКонтролируетсяПоНалогуНаПрибыль КАК ОснованиеКонтролируемости134,
	|	КонтролируемыеСделки.СделкаМорскогоМесторождения КАК ОснованиеКонтролируемости135,
	|	КонтролируемыеСделки.СделкаКонтролируетсяПоОсвобождениюНДС КАК ОснованиеКонтролируемости136,
	|	КонтролируемыеСделки.СделкаКонтролируетсяПоИнвестиционномуВычету КАК ОснованиеКонтролируемости137,
	|	КонтролируемыеСделки.СделкаКонтролируетсяПоДополнительномуДоходуОтСырья КАК ОснованиеКонтролируемости138,
...
Функция ПолучитьПараметрыАдресаСделки(Объект)
	...
	СведенияОбАдресе = УправлениеКонтактнойИнформациейБП.АдресСтруктурой(Объект, ВидКонтактнойИнформации);
...
Процедура ДобавитьСделкиОтчетаКомиссионераОПродажахЗависимымЛицам(Уведомление, МенеджерВременныхТаблиц, ТаблицаСделок)
	...
	|			И (ДокументыКонтролируемыхСделок.Контрагент = ОтчетКомиссионераОПродажахПокупатели.Покупатель)
	|		ЛЕВОЕ СОЕДИНЕНИЕ ТоварыМировойБиржевойТорговли КАК ТоварыМировойБиржевойТорговли
	|		ПО ОтчетКомиссионераОПродажахУслуги.Номенклатура = ТоварыМировойБиржевойТорговли.ПредметСделки
	|ГДЕ
	|	ОтчетКомиссионераОПродажахУслуги.Ссылка В
	|			(ВЫБРАТЬ
	|				ДокументыКонтролируемыхСделок.РасчетныйДокумент
