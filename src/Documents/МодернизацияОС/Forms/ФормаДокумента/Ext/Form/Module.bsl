...
// +СБ. Полякова Ирина. 2016-11-12. Redmine 2704
	СБ_РаботаСФормамиОбъекты.МодернизацияОСФормаДокументаПриСозданииНаСервере(ЭтаФорма, Отказ, СтандартнаяОбработка);
// -СБ. Полякова Ирина 
...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	//ОКЕЙ Назаренко Д.В. (СофтЛаб) Начало 2021-10-13 (#4405)
	...
	//ОКЕЙ Назаренко Д.В. (СофтЛаб) Конец 2021-10-13 (#4405) 
	КонецЕсли;
...
// +СБ. Полякова Ирина. 2016-11-12. Redmine 2704 
&НаКлиенте
Процедура Подключаемый_СБ_РазрезеСтатейЗатратПропорциональноПриИзменении(Элемент)
	
	Если Объект.ОК_ВРазрезеСтатейЗатрат Тогда
	
		Объект.ОК_ВРазрезеСтатейЗатрат = НЕ Объект.СБ_РазрезеСтатейЗатратПропорционально;
...
// +СБ. Полякова Ирина. 2016-11-12. Redmine 2704
&НаКлиенте
Процедура Подключаемый_ОК_ВРазрезеСтатейЗатратПриИзменении(Элемент)
	
	Если Объект.СБ_РазрезеСтатейЗатратПропорционально Тогда
	
		Объект.СБ_РазрезеСтатейЗатратПропорционально = НЕ Объект.ОК_ВРазрезеСтатейЗатрат;
...
//ОК Ванюков К. + //автоматическое заполнение на основании дебетового оборота за весь период в разрезе статей затрат //2012-02-17
&НаКлиенте
