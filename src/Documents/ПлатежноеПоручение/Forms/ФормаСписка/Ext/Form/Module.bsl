...
// +СБ. Широков Николай. 2015-02-25. Консультация #1356 
	//СБ_КазначействоКлиент.ПлатежноеПоручениеФормаСпискаПриОткрытии(ЭтаФорма);	
	ИжТиСи_СВД_Сервер.ОК_ВывестиРеквизиты(ЭтаФорма, "Документ.ПлатежноеПоручение.ФормаСписка");
// -СБ. Широков Николай 	
...
//ОКЕЙ Вдовиченко Г.В(СофтЛаб) Начало 2019-09-02 (#3436)
&НаКлиенте
Процедура ок_ОбновитьСостояние(Команда) Экспорт
	...
	ок_ОбменСБанкамиКлиент.ОбновитьСостояние(ВыделенныеСтроки);
