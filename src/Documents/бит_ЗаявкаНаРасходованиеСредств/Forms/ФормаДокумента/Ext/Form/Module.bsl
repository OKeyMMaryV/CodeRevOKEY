...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	МногострочныйДокумент = (Объект.Распределение.Количество() > 1) или Объект.ВидОперации = Перечисления.бит_ВидыОперацийЗаявкаНаРасходование.ПеречислениеДенежныхСредствПодотчетнику; 
...
Процедура ок_УстановитьВидимостьЭлементов()
	...
	Элементы.ОК_НеФормироватьПлатежноеПоручение.Видимость = Объект.ВидОперации 
	= ПредопределенноеЗначение("Перечисление.бит_ВидыОперацийЗаявкаНаРасходование.ПеречислениеДенежныхСредствПодотчетнику");
