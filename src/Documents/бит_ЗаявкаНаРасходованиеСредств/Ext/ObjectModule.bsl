...
Функция АктуализироватьПоКурсам(РежимСообщений = "Все") Экспорт 
	...
	Если Проведен Тогда
		Если НЕ ЕстьОплаты Тогда
			...
			Если (Реквизиты.Сценарий = СБ_КазначействоПовтИсп.ПолучитьЗначениеКонстанты("ок_ОперационныйСценарийПланирования") ИЛИ
				Реквизиты.Сценарий = СБ_КазначействоПовтИсп.ПолучитьЗначениеКонстанты("ок_ИнвестиционныйСценарийПланирования")) И
				Дата >= СБ_КазначействоПовтИсп.ПолучитьЗначениеКонстанты("ок_ДатаНачалаРаботыНовойЦелевойСхемыДвиженийПоБК",Дата('39990101')) Тогда
