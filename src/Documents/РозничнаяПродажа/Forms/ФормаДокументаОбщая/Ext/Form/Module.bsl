...
Процедура ВнешнееСобытие(Источник, Событие, Данные)
	...
	//ШтрихкодированиеИС
	ПараметрыОбработкиВводаШтрихкода = СобытияФормИСКлиент.ПараметрыОбработкиВводаШтрихкода();
	ПараметрыОбработкиВводаШтрихкода.Данные               = Данные;
	ПараметрыОбработкиВводаШтрихкода.Источник             = Источник;
	ПараметрыОбработкиВводаШтрихкода.Событие              = Событие;
	ПараметрыОбработкиВводаШтрихкода.КэшированныеЗначения = КэшированныеЗначения;
	СобытияФормИСКлиент.ВнешнееСобытиеОбработатьВводШтрихкода(ЭтотОбъект, ПараметрыОбработкиВводаШтрихкода);
...
Процедура ТоварыНоменклатураПриИзменении(Элемент)
	...
	ДанныеСтрокиТаблицы = Новый Структура(
		"Номенклатура, Количество, Цена, Сумма, СтавкаНДС ,СуммаНДС, Всего, ЭтоУслуга, ПродукцияМаркируемаяДляГИСМ, ОсобыйПорядок, ЭтоАлкогольнаяПродукция, ИндексАкцизнойМарки, АкцизнаяМарка");
...
Функция ТекстЗапросаТаблицаТоваров(НомераТаблиц)
	...
	|	ЕСТЬNULL(СправочникНоменклатура.ОбувнаяПродукция, ЛОЖЬ) КАК ЭтоОбувнаяПродукция,
	...
	|	ТаблицаЧека.ЭтоТабачнаяПродукция
	|		ИЛИ ТаблицаЧека.ЭтоОбувнаяПродукция КАК ЭтоМаркируемаяПродукция,
	|	ВЫБОР
	|		КОГДА ТаблицаЧека.ЭтоОбувнаяПродукция
	|			ТОГДА ЗНАЧЕНИЕ(Перечисление.ТипыМаркировкиККТ.ОбувныеТовары)
	|		КОГДА ТаблицаЧека.ЭтоТабачнаяПродукция
	...
	Для каждого СтрокаТовары Из ТаблицаДокумента Цикл
		...
		Если СтрокаТовары.ЭтоМаркируемаяПродукция 
			...
			Если ДанныеМаркировки.Разобран Тогда
				...
				СтрокаПозицииЧека.ДанныеКодаТоварнойНоменклатуры.ТипМаркировки                          = СтрокаТовары.ТипМаркировки;
