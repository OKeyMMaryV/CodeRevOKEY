...
Функция ПечатьРКО(МассивОбъектов, ОбъектыПечати)
	...
	Пока Шапка.Следующий() Цикл
		...
		ОбластьМакета.Параметры.ПредставлениеПодразделения = Шапка.ок_Объект;
...
Функция ТекстЗапросаПечатьРКО()
	...
	//ОКЕЙ Балыков А.Г. (ПервыйБИТ) Начало 2021-10-12 (#ТП_БП11_ФР14)
	|	РасходныйКассовыйОрдер.ок_Объект КАК ок_Объект,
	//ОКЕЙ Балыков А.Г. (ПервыйБИТ) Конец 2021-10-12 (#ТП_БП11_ФР14)
...
//ОКЕЙ Михайлова М.В.(ПервыйБИТ) Начало 2021-10-08 (#ТП_БП11_ФР03)

// Изменена периодичность нумерации - в пределах дня

//ОКЕЙ Михайлова М.В.(ПервыйБИТ) Конец  2021-10-08 (#ТП_БП11_ФР03)
