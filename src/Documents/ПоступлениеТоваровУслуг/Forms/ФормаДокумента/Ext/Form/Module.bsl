...
Функция ПолучитьСписокВидовОпераций()
	...
	КонецЕсли;
	СписокВидовОпераций.Добавить(ВсеВидыОпераций.УслугиАренды, ВсеВидыОпераций.УслугиАренды);
	Если ПолучитьФункциональнуюОпцию("ВедетсяУчетЛизинговогоИмущества") Тогда
		СписокВидовОпераций.Добавить(ВсеВидыОпераций.УслугиЛизинга, ВсеВидыОпераций.УслугиЛизинга);
	КонецЕсли;
	Если ПолучитьФункциональнуюОпцию("ИспользоватьФакторинг") Тогда
		СписокВидовОпераций.Добавить(ВсеВидыОпераций.УслугиФакторинга, ВсеВидыОпераций.УслугиФакторинга);
	КонецЕсли;
	Если ВедетсяУчетОсновныхСредств Тогда
