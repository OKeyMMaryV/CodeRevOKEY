...
Функция ТекстЗапросаВременныеТаблицыДокумента(НомераТаблиц)
	...
	//ОКЕЙ Лобанов В.И.(СофтЛаб) Начало 2018-07-09 (#3049)
	...
	//ОКЕЙ Лобанов В.И.(СофтЛаб) Конец 2018-07-09 (#3049)	
	|ПОМЕСТИТЬ ТаблицаТовары
	|ИЗ
	|	Документ.ПоступлениеДопРасходов.Товары КАК ТаблицаТовары
...
Функция ТекстЗапросаРасчетыВВалютеТовары()
	...
	// ОКЕЙ Смирнов М.В. (СофтЛаб) Начало 2021-09-28 (#4371)
	...
	// ОКЕЙ Смирнов М.В. (СофтЛаб) Конец 2021-09-28 (#4371)
