...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("МассивДополнительныхКолонок")
		И ТипЗнч(Параметры.МассивДополнительныхКолонок) = Тип("Массив") Тогда
		
		Для каждого ИмяКолонки Из Параметры.МассивДополнительныхКолонок Цикл
			ОбщегоНазначенияКлиентСервер.УстановитьСвойствоЭлементаФормы(Элементы, ИмяКолонки, "Видимость", Истина);
		КонецЦикла;
