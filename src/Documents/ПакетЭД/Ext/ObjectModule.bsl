...
Процедура ПриЗаписи(Отказ)
	...
	//ОКЕЙ Назаренко Д.В. (СофтЛаб) Начало 2021-02-08 (#4056) 
	|	И НЕ ПрисоединенныеФайлы.ПометкаУдаления = &ПометкаУдаления";
	Запрос.УстановитьПараметр("ПометкаУдаления", ПометкаУдаления);
	//ОКЕЙ Назаренко Д.В. (СофтЛаб) Конец 2021-02-08 (#4056)
