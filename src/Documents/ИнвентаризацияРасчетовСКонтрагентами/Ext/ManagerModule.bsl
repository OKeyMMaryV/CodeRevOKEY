...
//ОК Ванюков К. +// Доработка ИНВ-17 // 2012-05-11
...
Процедура ЗаполнитьПоОстаткам(ПараметрыЗаполнения, АдресХранилища) Экспорт
	...
	//ОК Ванюков К. +// Заполнение НомДокИмпорт // 2012-05-11
	//ОК+ Аверьянова С. 26.12.2016 ошибка при заполеннии документа, временно закомментирован 
	//|	ХозрасчетныйОстатки.Субконто1.НомДокИмпорт КАК ОК_НомДокИмпорт,
	//ОК-
	//ОК Ванюков К. -	
	|	ХозрасчетныйОстатки.Счет КАК СчетРасчетов,
	|	СУММА(ВЫБОР
//ОК Ванюков К. +// включением дебиторской задолженности по сч. 60.01  в часть ИНВ-17, содержащую дебетовые сальдо // 2012-05-11
	|			КОГДА ХозрасчетныйОстатки.Счет = Значение(ПланСчетов.Хозрасчетный.РасчетыСПоставщиками)
	|					И ХозрасчетныйОстатки.СуммаОстатокКт < 0	
	|				ТОГДА (СуммаОстатокКт * -1)
//ОК Ванюков К. -	
