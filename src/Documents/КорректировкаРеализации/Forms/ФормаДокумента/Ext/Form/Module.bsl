...
Процедура ТоварыНоменклатураПриИзменении(Элемент)
	...
	ДанныеСтрокиТаблицы = Новый Структура(
		...
		//ОКЕЙ Назаренко Д.В. (СофтЛаб) Начало 2021-08-04 (#4214)
		|ПрослеживаемыйТовар, РНПТ, ПодсказкаРНПТ, ИдентификаторСтроки,
		//ОКЕЙ Назаренко Д.В. (СофтЛаб) Конец 2021-08-04 (#4214) 
...
Процедура УстановитьУсловноеОформлениеУслуги() Экспорт
	...
	ЭлементУО.Оформление.УстановитьЗначениеПараметра("Доступность", Ложь);
	//ОКЕЙ Лещенко Д.Ю. (БИТ) Начало 2021-05-17 (#НТП-МП-03)
	Если ТипЗнч(Объект.ДокументРеализации) = Тип("ДокументСсылка.бит_ок_ОперацияАксапты") Тогда
...
Процедура ДокументРеализацииПриИзмененииНаКлиенте()
	...
	ок_ПриИзмененииДокументаРеализации();
	//ОКЕЙ Лещенко Д.Ю. (БИТ) Конец 2021-07-13 (#НТП-МП-03)
...
Процедура ок_ДобавитьРеквизитыСФ(Форма);
	...
	НовыйЭлемент = Форма.Элементы.Добавить("ок_СтраницаДанныеСФ",Тип("ГруппаФормы"),Форма.Элементы.ГруппаСтраницы);
    НовыйЭлемент.Вид = ВидГруппыФормы.Страница;
    НовыйЭлемент.Заголовок = "Данные исходной с\ф";
		
	НовыйЭлемент = Форма.Элементы.Добавить("Контрагент", Тип("ПолеФормы"), Форма.Элементы.ок_СтраницаДанныеСФ);
	НовыйЭлемент.Вид = ВидПоляФормы.ПолеВвода;
	НовыйЭлемент.ПутьКДанным = "Объект.Контрагент";
	НовыйЭлемент.Заголовок = "Контрагент";
	
	НовыйЭлемент = Форма.Элементы.Добавить("ДоговорКонтрагента", Тип("ПолеФормы"), Форма.Элементы.ок_СтраницаДанныеСФ);
	НовыйЭлемент.Вид = ВидПоляФормы.ПолеВвода;
	НовыйЭлемент.ПутьКДанным = "Объект.ДоговорКонтрагента";
	НовыйЭлемент.Заголовок = "Договор";
	...
	Если ТипЗнч(Форма.Объект.ДокументРеализации) = Тип("ДокументСсылка.бит_ок_ОперацияАксапты") Тогда
		Форма.Элементы.ок_СтраницаДанныеСФ.Видимость = Истина;
	Иначе
		Форма.Элементы.ок_СтраницаДанныеСФ.Видимость = Ложь;
	КонецЕсли;

КонецПроцедуры	

Процедура ок_ПриИзмененииДокументаРеализации()
...
&НаКлиентеНаСервереБезКонтекста
Процедура ОтобразитьПолеУПД(Форма)
