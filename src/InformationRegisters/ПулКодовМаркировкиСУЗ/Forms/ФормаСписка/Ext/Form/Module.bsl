...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	ОбщегоНазначенияКлиентСервер.УстановитьПараметрДинамическогоСписка(Список, "ПустоеОснование",
		ИнтеграцияИС.ПустоеЗначениеОпределяемогоТипа("ОснованиеЗаказНаЭмиссиюКодовМаркировкиИСМП"), Истина);
...
Процедура УстановитьТекстОтбораПоДоступнымМетаданнымОснования()
	...
	СтрокиОтбораДокументов.Добавить("ПулКодовМаркировкиСУЗ.ДокументОснование = &ПустоеОснование");
