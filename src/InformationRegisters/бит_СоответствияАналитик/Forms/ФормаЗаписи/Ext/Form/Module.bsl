...
Процедура АналитикаНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	//Элемент.ВыбиратьТип = фКэшЗначений.ПараметрыАналитик[Элемент.Имя].КоличествоТипов > 1 И НЕ ЗначениеЗаполнено(Запись[Элемент.Имя]); //.
...
Процедура УстановитьПараметрыВыбора()
	...
	//izhtc-Kir 08.09.2015 (перенес это в форму выбора Справочник.бит_СтатьиОборотов
