...
Процедура ЗагрузитьКурсыПодчиненныхВалют()
	...
	Для Каждого ЗаписьВалютыВладельца Из ЭтотОбъект Цикл
		...
		ЗависимыеВалюты = бит_КурсыВалют.ПолучитьСписокЗависимыхВалют(ЗаписьВалютыВладельца.Валюта, ДополнительныеСвойства);
...
Процедура УдалитьКурсыПодчиненныхВалют()
	...
	ЗависимыеВалюты = бит_КурсыВалют.ПолучитьСписокЗависимыхВалют(ВалютаВладелец, ДополнительныеСвойства);
	Для Каждого СтрокаТаблицы Из ЗависимыеВалюты Цикл
