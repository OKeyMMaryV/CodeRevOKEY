...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	МетаданныеОбъекта = Метаданные.РегистрыБухгалтерии.бит_Дополнительный_1;
...
Процедура ПереключитьАктивностьПроводок(Команда)
	...
	ОчиститьСообщения();
	Если НЕ ПереключениеПроводокДоступно(ТекущиеДанные, "бит_Дополнительный_1") Тогда
	    Возврат;
	КонецЕсли; 
...
Процедура ПереключитьАктивностьПроводокСервер(Документ)
	...
	бит_ОбщегоНазначения.ПереключитьАктивностьПроводокДокументаДляРегистраБухгалтерии(Документ, "бит_Дополнительный_1");
